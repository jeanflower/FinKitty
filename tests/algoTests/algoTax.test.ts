...
import { ModelData, ReportValueChecker } from "../../types/interfaces";
...
import {
  ...
  getTestEvaluationsForReport,
  printTestCodeForReportData,
} from "./algoTestUtils";
...
describe("tax tests", () => {
  ...
  it("payLowTax on two 2w income payment", () => {
    ...
    expectEvals(evals, 3, 'PRnd', 'Thu Mar 08 2018', 2501, -1);
    expectEvals(evals, 4, 'Cash', 'Thu Mar 08 2018', 5502, -1);
    expectEvals(evals, 5, 'PRnd', 'Thu Mar 15 2018', 2501, -1);
    expectEvals(evals, 6, 'Cash', 'Thu Mar 15 2018', 8003, -1);
    expectEvals(evals, 7, 'PRnd', 'Thu Mar 22 2018', 2501, -1);
    expectEvals(evals, 8, 'Cash', 'Thu Mar 22 2018', 10504, -1);
    expectEvals(evals, 9, 'PRnd', 'Thu Mar 29 2018', 2501, -1);
    expectEvals(evals, 10, 'Cash', 'Thu Mar 29 2018', 13005, -1);
    expectEvals(evals, 11, 'Cash', 'Sun Apr 01 2018', 13005, -1);
    expectEvals(evals, 12, 'Cash', 'Thu Apr 05 2018', 13004, -1);
    expectEvals(evals, 13, '(incomeTax)', 'Thu Apr 05 2018', 1, -1);
    expectEvals(evals, 14, 'Joe income (net)', 'Thu Apr 05 2018', 12504, -1);
    expectEvals(evals, 15, 'Cash', 'Tue May 01 2018', 13004, -1);
  ...
  it("taxBands grow with cpi", () => {
    ...
    expectChartData(chartPts, 6, 'Thu Oct 01 2020', 7797.73, 2);
    expectChartData(chartPts, 7, 'Sun Nov 01 2020', 8840.38, 2);
    expectChartData(chartPts, 8, 'Tue Dec 01 2020', 9883.08, 2);
    expectChartData(chartPts, 9, 'Fri Jan 01 2021', 10925.82, 2);
    expectChartData(chartPts, 10, 'Mon Feb 01 2021', 11968.61, 2);
    expectChartData(chartPts, 11, 'Mon Mar 01 2021', 13011.44, 2);
    expectChartData(chartPts, 12, 'Thu Apr 01 2021', 14054.31, 2);
    ...
    expectChartData(chartPts, 18, 'Fri Oct 01 2021', 20312.49, 2);
    expectChartData(chartPts, 19, 'Mon Nov 01 2021', 21355.67, 2);
    expectChartData(chartPts, 20, 'Wed Dec 01 2021', 22398.89, 2);
    expectChartData(chartPts, 21, 'Sat Jan 01 2022', 23442.15, 2);
    expectChartData(chartPts, 22, 'Tue Feb 01 2022', 24485.46, 2);
    expectChartData(chartPts, 23, 'Tue Mar 01 2022', 25528.81, 2);
    expectChartData(chartPts, 24, 'Fri Apr 01 2022', 26572.20, 2);
    ...
    expectChartData(chartPts, 39, 'Sat Jul 01 2023', 42230.70, 2);
    ...
    expectChartData(chartPts, 43, 'Wed Nov 01 2023', 46408.00, 2);
    ...
    expectChartData(chartPts, 48, 'Mon Apr 01 2024', 51630.60, 2);
  ...
  it("payTopTax on separate income payments", () => {
    ...
    ) =>
    {
      ...
      const result =
        ...
        name.startsWith("PRn1") || name.startsWith("PRn2");
        // console.log(`include ${name} for report? ${result}`);
      return result;
    };

    const evalsAndValues = getTestEvaluationsForReport(model, reporter);
    const evals = evalsAndValues.evaluations;
    // log(`evals = ${showObj(evals)}`);
    ...
    // log(`reportData = ${showObj(evalsAndValues.reportData)}`);
    expect(evalsAndValues.reportData.length).toBe(2);
    expect(evalsAndValues.reportData[0].date).toEqual("01 Jan 2018");
    expect(evalsAndValues.reportData[0].name).toBe("PRn1");
    expect(evalsAndValues.reportData[0].newVal).toBe(75100);
    expect(evalsAndValues.reportData[1].date).toEqual("01 Jan 2018");
    expect(evalsAndValues.reportData[1].name).toBe("PRn2");
    expect(evalsAndValues.reportData[1].newVal).toBe(75000);
  });

  it("multiple monthly Pension payments", () => {
    const roi = {
      start: "April 1, 2018 00:00:00",
      end: "July 10, 2019 00:00:00",
    };
    const model: ModelData = {
      ...emptyModel,
      incomes: [
    ...
    const evalsAndValues = getTestEvaluationsForReport(model, reporter);
    const evals = evalsAndValues.evaluations;
    const reportData = evalsAndValues.reportData;
    
    // printTestCodeForReportData(evalsAndValues.reportData);
    // log(`reportData = ${showObj(evalsAndValues.reportData)}`);
    expect(reportData.length).toBe(27);
    expect(reportData[0].date).toEqual('01 Jun 2018');
    expect(reportData[0].name).toBe('incomeFixedPRn1');
    expect(reportData[0].oldVal).toBe(undefined);
    expect(reportData[0].newVal).toBeCloseTo(10000, 2);
    expect(reportData[1].date).toEqual('05 Jun 2018');
    expect(reportData[1].name).toBe('taxForFixedJoe(incomeTax) for month');
    expect(reportData[1].oldVal).toBe(undefined);
    expect(reportData[1].newVal).toBeCloseTo(-2954.54, 2);
    expect(reportData[2].date).toEqual('01 Jul 2018');
    expect(reportData[2].name).toBe('incomeFixedPRn1');
    expect(reportData[2].oldVal).toBeCloseTo(10000, 2);
    expect(reportData[2].newVal).toBeCloseTo(10000, 2);
    expect(reportData[3].date).toEqual('05 Jul 2018');
    expect(reportData[3].name).toBe('taxForFixedJoe(incomeTax) for month');
    expect(reportData[3].oldVal).toBeCloseTo(-2954.54, 2);
    expect(reportData[3].newVal).toBeCloseTo(-2954.54, 2);
    expect(reportData[4].date).toEqual('01 Aug 2018');
    expect(reportData[4].name).toBe('incomeFixedPRn1');
    expect(reportData[4].oldVal).toBeCloseTo(10000, 2);
    expect(reportData[4].newVal).toBeCloseTo(10000, 2);
    expect(reportData[5].date).toEqual('05 Aug 2018');
    expect(reportData[5].name).toBe('taxForFixedJoe(incomeTax) for month');
    expect(reportData[5].oldVal).toBeCloseTo(-2954.54, 2);
    expect(reportData[5].newVal).toBeCloseTo(-2954.54, 2);
    expect(reportData[6].date).toEqual('01 Sept 2018');
    expect(reportData[6].name).toBe('incomeFixedPRn1');
    expect(reportData[6].oldVal).toBeCloseTo(10000, 2);
    expect(reportData[6].newVal).toBeCloseTo(10000, 2);
    expect(reportData[7].date).toEqual('05 Sept 2018');
    expect(reportData[7].name).toBe('taxForFixedJoe(incomeTax) for month');
    expect(reportData[7].oldVal).toBeCloseTo(-2954.54, 2);
    expect(reportData[7].newVal).toBeCloseTo(-2954.54, 2);
    expect(reportData[8].date).toEqual('01 Oct 2018');
    expect(reportData[8].name).toBe('incomeFixedPRn1');
    expect(reportData[8].oldVal).toBeCloseTo(10000, 2);
    expect(reportData[8].newVal).toBeCloseTo(10000, 2);
    expect(reportData[9].date).toEqual('05 Oct 2018');
    expect(reportData[9].name).toBe('taxForFixedJoe(incomeTax) for month');
    expect(reportData[9].oldVal).toBeCloseTo(-2954.54, 2);
    expect(reportData[9].newVal).toBeCloseTo(-2954.54, 2);
    expect(reportData[10].date).toEqual('01 Nov 2018');
    expect(reportData[10].name).toBe('incomeFixedPRn1');
    expect(reportData[10].oldVal).toBeCloseTo(10000, 2);
    expect(reportData[10].newVal).toBeCloseTo(10000, 2);
    expect(reportData[11].date).toEqual('05 Nov 2018');
    expect(reportData[11].name).toBe('taxForFixedJoe(incomeTax) for month');
    expect(reportData[11].oldVal).toBeCloseTo(-2954.54, 2);
    expect(reportData[11].newVal).toBeCloseTo(-2954.55, 2);
    expect(reportData[12].date).toEqual('01 Dec 2018');
    expect(reportData[12].name).toBe('incomeFixedPRn1');
    expect(reportData[12].oldVal).toBeCloseTo(10000, 2);
    expect(reportData[12].newVal).toBeCloseTo(10000, 2);
    expect(reportData[13].date).toEqual('05 Dec 2018');
    expect(reportData[13].name).toBe('taxForFixedJoe(incomeTax) for month');
    expect(reportData[13].oldVal).toBeCloseTo(-2954.55, 2);
    expect(reportData[13].newVal).toBeCloseTo(-2954.55, 2);
    expect(reportData[14].date).toEqual('01 Jan 2019');
    expect(reportData[14].name).toBe('incomeFixedPRn1');
    expect(reportData[14].oldVal).toBeCloseTo(10000, 2);
    expect(reportData[14].newVal).toBeCloseTo(10000, 2);
    expect(reportData[15].date).toEqual('05 Jan 2019');
    expect(reportData[15].name).toBe('taxForFixedJoe(incomeTax) for month');
    expect(reportData[15].oldVal).toBeCloseTo(-2954.55, 2);
    expect(reportData[15].newVal).toBeCloseTo(-2954.55, 2);
    expect(reportData[16].date).toEqual('01 Feb 2019');
    expect(reportData[16].name).toBe('incomeFixedPRn1');
    expect(reportData[16].oldVal).toBeCloseTo(10000, 2);
    expect(reportData[16].newVal).toBeCloseTo(10000, 2);
    expect(reportData[17].date).toEqual('05 Feb 2019');
    expect(reportData[17].name).toBe('taxForFixedJoe(incomeTax) for month');
    expect(reportData[17].oldVal).toBeCloseTo(-2954.55, 2);
    expect(reportData[17].newVal).toBeCloseTo(-2954.55, 2);
    expect(reportData[18].date).toEqual('01 Mar 2019');
    expect(reportData[18].name).toBe('incomeFixedPRn1');
    expect(reportData[18].oldVal).toBeCloseTo(10000, 2);
    expect(reportData[18].newVal).toBeCloseTo(10000, 2);
    expect(reportData[19].date).toEqual('05 Mar 2019');
    expect(reportData[19].name).toBe('taxForFixedJoe(incomeTax) for month');
    expect(reportData[19].oldVal).toBeCloseTo(-2954.55, 2);
    expect(reportData[19].newVal).toBeCloseTo(-2954.55, 2);
    expect(reportData[20].date).toEqual('01 Apr 2019');
    expect(reportData[20].name).toBe('incomeFixedPRn1');
    expect(reportData[20].oldVal).toBeCloseTo(10000, 2);
    expect(reportData[20].newVal).toBeCloseTo(10000, 2);
    expect(reportData[21].date).toEqual('05 Apr 2019');
    expect(reportData[21].name).toBe('taxForFixedJoe incomeTax end of year');
    expect(reportData[21].oldVal).toBe(undefined);
    expect(reportData[21].newVal).toBeCloseTo(-2954.55, 2);
    expect(reportData[22].date).toEqual('01 May 2019');
    expect(reportData[22].name).toBe('incomeFixedPRn1');
    expect(reportData[22].oldVal).toBeCloseTo(10000, 2);
    expect(reportData[22].newVal).toBeCloseTo(10000, 2);
    expect(reportData[23].date).toEqual('05 May 2019');
    expect(reportData[23].name).toBe('taxForFixedJoe(incomeTax) for month');
    expect(reportData[23].oldVal).toBeCloseTo(-2954.55, 2);
    expect(reportData[23].newVal).toBeCloseTo(-3125, 2);
    expect(reportData[24].date).toEqual('01 Jun 2019');
    expect(reportData[24].name).toBe('incomeFixedPRn1');
    expect(reportData[24].oldVal).toBeCloseTo(10000, 2);
    expect(reportData[24].newVal).toBeCloseTo(10000, 2);
    expect(reportData[25].date).toEqual('05 Jun 2019');
    expect(reportData[25].name).toBe('taxForFixedJoe(incomeTax) for month');
    expect(reportData[25].oldVal).toBeCloseTo(-3125, 2);
    expect(reportData[25].newVal).toBeCloseTo(-3125, 2);
    expect(reportData[26].date).toEqual('05 Apr 2020');
    expect(reportData[26].name).toBe('taxForFixedJoe incomeTax end of year');
    expect(reportData[26].oldVal).toBeCloseTo(-2954.55, 2);
    expect(reportData[26].newVal).toBeCloseTo(4750, 2);

    // printTestCodeForEvals(evals);

    expect(evals.length).toBe(60);
    expectEvals(evals, 0, 'Cash', 'Sun Apr 01 2018', 500, -1);
    expectEvals(evals, 1, 'Cash', 'Tue May 01 2018', 500, -1);
    expectEvals(evals, 2, 'Cash', 'Fri Jun 01 2018', 500, -1);
    expectEvals(evals, 3, 'PRn1', 'Fri Jun 01 2018', 10000, -1);
    expectEvals(evals, 4, 'Cash', 'Fri Jun 01 2018', 10500, -1);
    expectEvals(evals, 5, 'Cash', 'Tue Jun 05 2018', 7545.46, 2);
    expectEvals(evals, 6, 'Cash', 'Sun Jul 01 2018', 7545.46, 2);
    expectEvals(evals, 7, 'PRn1', 'Sun Jul 01 2018', 10000, -1);
    expectEvals(evals, 8, 'Cash', 'Sun Jul 01 2018', 17545.46, 2);
    expectEvals(evals, 9, 'Cash', 'Thu Jul 05 2018', 14590.92, 2);
    expectEvals(evals, 10, 'Cash', 'Wed Aug 01 2018', 14590.92, 2);
    expectEvals(evals, 11, 'PRn1', 'Wed Aug 01 2018', 10000, -1);
    expectEvals(evals, 12, 'Cash', 'Wed Aug 01 2018', 24590.92, 2);
    expectEvals(evals, 13, 'Cash', 'Sun Aug 05 2018', 21636.38, 2);
    expectEvals(evals, 14, 'Cash', 'Sat Sep 01 2018', 21636.38, 2);
    expectEvals(evals, 15, 'PRn1', 'Sat Sep 01 2018', 10000, -1);
    expectEvals(evals, 16, 'Cash', 'Sat Sep 01 2018', 31636.38, 2);
    expectEvals(evals, 17, 'Cash', 'Wed Sep 05 2018', 28681.84, 2);
    expectEvals(evals, 18, 'Cash', 'Mon Oct 01 2018', 28681.84, 2);
    expectEvals(evals, 19, 'PRn1', 'Mon Oct 01 2018', 10000, -1);
    expectEvals(evals, 20, 'Cash', 'Mon Oct 01 2018', 38681.84, 2);
    expectEvals(evals, 21, 'Cash', 'Fri Oct 05 2018', 35727.30, 2);
    expectEvals(evals, 22, 'Cash', 'Thu Nov 01 2018', 35727.30, 2);
    expectEvals(evals, 23, 'PRn1', 'Thu Nov 01 2018', 10000, -1);
    expectEvals(evals, 24, 'Cash', 'Thu Nov 01 2018', 45727.30, 2);
    expectEvals(evals, 25, 'Cash', 'Mon Nov 05 2018', 42772.75, 2);
    expectEvals(evals, 26, 'Cash', 'Sat Dec 01 2018', 42772.75, 2);
    expectEvals(evals, 27, 'PRn1', 'Sat Dec 01 2018', 10000, -1);
    expectEvals(evals, 28, 'Cash', 'Sat Dec 01 2018', 52772.75, 2);
    expectEvals(evals, 29, 'Cash', 'Wed Dec 05 2018', 49818.20, 2);
    expectEvals(evals, 30, 'Cash', 'Tue Jan 01 2019', 49818.20, 2);
    expectEvals(evals, 31, 'PRn1', 'Tue Jan 01 2019', 10000, -1);
    expectEvals(evals, 32, 'Cash', 'Tue Jan 01 2019', 59818.20, 2);
    expectEvals(evals, 33, 'Cash', 'Sat Jan 05 2019', 56863.65, 2);
    expectEvals(evals, 34, 'Cash', 'Fri Feb 01 2019', 56863.65, 2);
    expectEvals(evals, 35, 'PRn1', 'Fri Feb 01 2019', 10000, -1);
    expectEvals(evals, 36, 'Cash', 'Fri Feb 01 2019', 66863.65, 2);
    expectEvals(evals, 37, 'Cash', 'Tue Feb 05 2019', 63909.10, 2);
    expectEvals(evals, 38, 'Cash', 'Fri Mar 01 2019', 63909.10, 2);
    expectEvals(evals, 39, 'PRn1', 'Fri Mar 01 2019', 10000, -1);
    expectEvals(evals, 40, 'Cash', 'Fri Mar 01 2019', 73909.10, 2);
    expectEvals(evals, 41, 'Cash', 'Tue Mar 05 2019', 70954.55, 2);
    expectEvals(evals, 42, 'Cash', 'Mon Apr 01 2019', 70954.55, 2);
    expectEvals(evals, 43, 'PRn1', 'Mon Apr 01 2019', 10000, -1);
    expectEvals(evals, 44, 'Cash', 'Mon Apr 01 2019', 80954.55, 2);
    expectEvals(evals, 45, 'Cash', 'Fri Apr 05 2019', 78000.00, 2);
    expectEvals(evals, 46, '(incomeTax)', 'Fri Apr 05 2019', 32500, -1);
    expectEvals(evals, 47, 'Joe income (net)', 'Fri Apr 05 2019', 77500, -1);
    expectEvals(evals, 48, 'Cash', 'Wed May 01 2019', 78000.00, 2);
    expectEvals(evals, 49, 'PRn1', 'Wed May 01 2019', 10000, -1);
    expectEvals(evals, 50, 'Cash', 'Wed May 01 2019', 88000.00, 2);
    expectEvals(evals, 51, 'Cash', 'Sun May 05 2019', 84875.00, 2);
    expectEvals(evals, 52, 'Cash', 'Sat Jun 01 2019', 84875.00, 2);
    expectEvals(evals, 53, 'PRn1', 'Sat Jun 01 2019', 10000, -1);
    expectEvals(evals, 54, 'Cash', 'Sat Jun 01 2019', 94875.00, 2);
    expectEvals(evals, 55, 'Cash', 'Wed Jun 05 2019', 91750.00, 2);
    expectEvals(evals, 56, 'Cash', 'Mon Jul 01 2019', 91750.00, 2);
    expectEvals(evals, 57, 'Cash', 'Sun Apr 05 2020', 96500.00, 2);
    expectEvals(evals, 58, '(incomeTax)', 'Sun Apr 05 2020', 1500, -1);
    expectEvals(evals, 59, 'Joe income (net)', 'Sun Apr 05 2020', 18500, -1);
    ...
    expectChartData(chartPts, 0, 'Sun Apr 01 2018', 0, -1);
    expectChartData(chartPts, 1, 'Tue May 01 2018', 0, -1);
    expectChartData(chartPts, 2, 'Fri Jun 01 2018', 10000, -1);
    expectChartData(chartPts, 3, 'Sun Jul 01 2018', 10000, -1);
    expectChartData(chartPts, 4, 'Wed Aug 01 2018', 10000, -1);
    expectChartData(chartPts, 5, 'Sat Sep 01 2018', 10000, -1);
    expectChartData(chartPts, 6, 'Mon Oct 01 2018', 10000, -1);
    expectChartData(chartPts, 7, 'Thu Nov 01 2018', 10000, -1);
    expectChartData(chartPts, 8, 'Sat Dec 01 2018', 10000, -1);
    expectChartData(chartPts, 9, 'Tue Jan 01 2019', 10000, -1);
    expectChartData(chartPts, 10, 'Fri Feb 01 2019', 10000, -1);
    expectChartData(chartPts, 11, 'Fri Mar 01 2019', 10000, -1);
    expectChartData(chartPts, 12, 'Mon Apr 01 2019', 10000, -1);
    expectChartData(chartPts, 13, 'Wed May 01 2019', 10000, -1);
    expectChartData(chartPts, 14, 'Sat Jun 01 2019', 10000, -1);
    expectChartData(chartPts, 15, 'Mon Jul 01 2019', 0, -1);
    }
    ...
    expectChartData(chartPts, 2, 'Fri Jun 01 2018', 10500, -1);
    expectChartData(chartPts, 3, 'Sun Jul 01 2018', 17545.46, 2);
    expectChartData(chartPts, 4, 'Wed Aug 01 2018', 24590.92, 2);
    expectChartData(chartPts, 5, 'Sat Sep 01 2018', 31636.38, 2);
    expectChartData(chartPts, 6, 'Mon Oct 01 2018', 38681.84, 2);
    expectChartData(chartPts, 7, 'Thu Nov 01 2018', 45727.30, 2);
    expectChartData(chartPts, 8, 'Sat Dec 01 2018', 52772.75, 2);
    expectChartData(chartPts, 9, 'Tue Jan 01 2019', 59818.20, 2);
    expectChartData(chartPts, 10, 'Fri Feb 01 2019', 66863.65, 2);
    expectChartData(chartPts, 11, 'Fri Mar 01 2019', 73909.10, 2);
    expectChartData(chartPts, 12, 'Mon Apr 01 2019', 80954.55, 2);
    expectChartData(chartPts, 13, 'Wed May 01 2019', 88000, -1);
    expectChartData(chartPts, 14, 'Sat Jun 01 2019', 94875, -1);
    expectChartData(chartPts, 15, 'Mon Jul 01 2019', 91750, -1);
    }
    ...
    expectChartData(chartPts, 6, 'Mon Oct 01 2018', 0, -1);
    expectChartData(chartPts, 7, 'Thu Nov 01 2018', 0, -1);
    expectChartData(chartPts, 8, 'Sat Dec 01 2018', 0, -1);
    expectChartData(chartPts, 9, 'Tue Jan 01 2019', 0, -1);
    expectChartData(chartPts, 10, 'Fri Feb 01 2019', 0, -1);
    expectChartData(chartPts, 11, 'Fri Mar 01 2019', 0, -1);
    expectChartData(chartPts, 12, 'Mon Apr 01 2019', 0, -1);
    expectChartData(chartPts, 13, 'Wed May 01 2019', 32500, -1);
    expectChartData(chartPts, 14, 'Sat Jun 01 2019', 0, -1);
    expectChartData(chartPts, 15, 'Mon Jul 01 2019', 0, -1);
    }
    ...
    expectChartData(chartPts, 11, 'Fri Mar 01 2019', 0, -1);
    expectChartData(chartPts, 12, 'Mon Apr 01 2019', 0, -1);
    expectChartData(chartPts, 13, 'Wed May 01 2019', 77500, -1);
    expectChartData(chartPts, 14, 'Sat Jun 01 2019', 0, -1);
    expectChartData(chartPts, 15, 'Mon Jul 01 2019', 0, -1);
    }
  });
  ...
  it("own some cars liable to income tax", () => { // BUG this income seems not not use QUANTITY
    const roi = {
      start: "Dec 1, 2017 00:00:00",
      end: "June 1, 2018 00:00:00",
    };
    ...
    expectEvals(evals, 9, 'Cars', 'Fri Mar 02 2018', 457205.34, 2);
    expectEvals(evals, 10, 'Cars2', 'Fri Mar 02 2018', 450000, -1);
    expectEvals(evals, 11, 'Cash', 'Sun Apr 01 2018', 0, -1);
    expectEvals(evals, 12, 'Cars', 'Mon Apr 02 2018', 460851.16, 2);
    expectEvals(evals, 13, 'Cars2', 'Mon Apr 02 2018', 450000, -1);
    expectEvals(evals, 14, 'Joe income (net)', 'Thu Apr 05 2018', 3617.05, 2);
    expectEvals(evals, 15, 'Cash', 'Tue May 01 2018', 0, -1);
    expectEvals(evals, 16, 'Cars', 'Wed May 02 2018', 464526.05, 2);
    expectEvals(evals, 17, 'Cars2', 'Wed May 02 2018', 450000, -1);
    expectEvals(evals, 18, 'Joe income (net)', 'Fri Apr 05 2019', 1224.96, 2);
    ...
    expect(result.assetData[1].item.NAME).toBe('Cars2');
    {
    const chartPts = result.assetData[1].chartDataPoints;
    expect(chartPts.length).toBe(6);
    expectChartData(chartPts, 0, 'Fri Dec 01 2017', 0, -1);
    ...
    it("own some valuable cars liable to income tax", () => { // BUG this income seems not not use QUANTITY
    const roi = {
      start: "Dec 1, 2017 00:00:00",
      end: "June 1, 2018 00:00:00",
    };
    ...
    const model: ModelData = {
      ...
      assets: [
        ...minimalModel.assets,
        {
          ...
          NAME: "Cars",
          START: "January 2 2018",
          VALUE: "1500000", // value for each car
          QUANTITY: "3",
          LIABILITY: "Joe(incomeTax)",
          GROWTH: "10.0",
        },
    ...
    expectEvals(evals, 0, 'Cash', 'Mon Jan 01 2018', 0, -1);
    expectEvals(evals, 1, 'quantityCars', 'Tue Jan 02 2018', 3, -1);
    expectEvals(evals, 2, 'Cars', 'Tue Jan 02 2018', 4500000, -1);
    expectEvals(evals, 3, 'quantityCars2', 'Tue Jan 02 2018', 3, -1);
    expectEvals(evals, 4, 'Cars2', 'Tue Jan 02 2018', 4500000, -1);
    expectEvals(evals, 5, 'Cash', 'Thu Feb 01 2018', 0, -1);
    expectEvals(evals, 6, 'Cars', 'Fri Feb 02 2018', 4535883.63, 2);
    expectEvals(evals, 7, 'Cars2', 'Fri Feb 02 2018', 4500000, -1);
    expectEvals(evals, 8, 'Cash', 'Mon Feb 05 2018', -1558.90, 2);
    expectEvals(evals, 9, 'Cash', 'Thu Mar 01 2018', -1558.90, 2);
    expectEvals(evals, 10, 'Cars', 'Fri Mar 02 2018', 4572053.40, 2);
    expectEvals(evals, 11, 'Cars2', 'Fri Mar 02 2018', 4500000, -1);
    expectEvals(evals, 12, 'Cash', 'Mon Mar 05 2018', -3136.88, 2);
    expectEvals(evals, 13, 'Cash', 'Sun Apr 01 2018', -3136.88, 2);
    expectEvals(evals, 14, 'Cars', 'Mon Apr 02 2018', 4608511.60, 2);
    expectEvals(evals, 15, 'Cars2', 'Mon Apr 02 2018', 4500000, -1);
    expectEvals(evals, 16, 'Cash', 'Thu Apr 05 2018', -4734.11, 2);
    expectEvals(evals, 17, '(incomeTax)', 'Thu Apr 05 2018', 4734.11, 2);
    expectEvals(evals, 18, 'Joe income (net)', 'Thu Apr 05 2018', 31436.43, 2);
    expectEvals(evals, 19, 'Cash', 'Tue May 01 2018', -4734.11, 2);
    expectEvals(evals, 20, 'Cars', 'Wed May 02 2018', 4645260.52, 2);
    expectEvals(evals, 21, 'Cars2', 'Wed May 02 2018', 4500000, -1);
    expectEvals(evals, 22, 'Joe income (net)', 'Fri Apr 05 2019', 12249.64, 2);
    ...
    expectChartData(chartPts, 1, 'Mon Jan 01 2018', 0, -1);
    expectChartData(chartPts, 2, 'Thu Feb 01 2018', 0, -1);
    expectChartData(chartPts, 3, 'Thu Mar 01 2018', -1558.90, 2);
    expectChartData(chartPts, 4, 'Sun Apr 01 2018', -3136.88, 2);
    expectChartData(chartPts, 5, 'Tue May 01 2018', -4734.11, 2);
    }
    ...
    expectChartData(chartPts, 0, 'Fri Dec 01 2017', 0, -1);
    expectChartData(chartPts, 1, 'Mon Jan 01 2018', 0, -1);
    expectChartData(chartPts, 2, 'Thu Feb 01 2018', 4500000, -1);
    expectChartData(chartPts, 3, 'Thu Mar 01 2018', 4535883.63, 2);
    expectChartData(chartPts, 4, 'Sun Apr 01 2018', 4572053.40, 2);
    expectChartData(chartPts, 5, 'Tue May 01 2018', 4608511.60, 2);
    }
    ...
    expectChartData(chartPts, 1, 'Mon Jan 01 2018', 0, -1);
    expectChartData(chartPts, 2, 'Thu Feb 01 2018', 4500000, -1);
    expectChartData(chartPts, 3, 'Thu Mar 01 2018', 4500000, -1);
    expectChartData(chartPts, 4, 'Sun Apr 01 2018', 4500000, -1);
    expectChartData(chartPts, 5, 'Tue May 01 2018', 4500000, -1);
    }
    ...
    expectChartData(chartPts, 3, 'Thu Mar 01 2018', 0, -1);
    expectChartData(chartPts, 4, 'Sun Apr 01 2018', 0, -1);
    expectChartData(chartPts, 5, 'Tue May 01 2018', 31436.43, 2);
  }
});
