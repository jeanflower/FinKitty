...
function assertData(
  ...
  if (createButtonID === 'btn-create-Simple-example') {
    ...
    expect(ary.datasets[0].data[0]).toBeCloseTo(7018.19, 6);
    expect(ary.datasets[0].data[1]).toBeCloseTo(12276.15, 6);
    expect(ary.datasets[0].data[2]).toBeCloseTo(18245.19, 6);
    expect(ary.datasets[0].data[3]).toBeCloseTo(24957.66, 6);
    expect(ary.datasets[0].data[4]).toBeCloseTo(32456.34, 6);
    expect(ary.datasets[0].data[5]).toBeCloseTo(40771.47, 6);
    expect(ary.datasets[0].data[6]).toBeCloseTo(49934.31, 6);
    expect(ary.datasets[0].data[7]).toBeCloseTo(61663.14, 6);
    expect(ary.datasets[0].data[8]).toBeCloseTo(82701.38, 6);
    expect(ary.datasets[0].data[9]).toBeCloseTo(106450.99, 6);
    expect(ary.datasets[0].data[10]).toBeCloseTo(129996.93, 6);
    expect(ary.datasets[0].data[11]).toBeCloseTo(136911.46, 6);
    expect(ary.datasets[0].data[12]).toBeCloseTo(138650, 6);
    expect(ary.datasets[0].data[13]).toBeCloseTo(140905.69, 6);
    expect(ary.datasets[0].data[14]).toBeCloseTo(143703.33, 6);
    expect(ary.datasets[0].data[15]).toBeCloseTo(150119.43, 6);
    expect(ary.datasets[0].data[16]).toBeCloseTo(172360.58, 6);
    expect(ary.datasets[0].data[17]).toBeCloseTo(195680.65, 6);
    expect(ary.datasets[0].data[18]).toBeCloseTo(220119.68, 6);
    expect(ary.datasets[0].data[19]).toBeCloseTo(245719.04, 6);
    expect(ary.datasets[0].data[20]).toBeCloseTo(272521.48, 6);
    expect(ary.datasets[0].data[21]).toBeCloseTo(300571.14, 6);
    expect(ary.datasets[0].data[22]).toBeCloseTo(329913.66, 6);
    ...
    expect(ary.datasets[0].data[4]).toBeCloseTo(27602.04, 6);
    expect(ary.datasets[0].data[5]).toBeCloseTo(51412.4, 6);
    expect(ary.datasets[0].data[6]).toBeCloseTo(74089.64, 6);
    expect(ary.datasets[0].data[7]).toBeCloseTo(96905.44, 6);
    expect(ary.datasets[0].data[8]).toBeCloseTo(119805.04, 6);
    expect(ary.datasets[0].data[9]).toBeCloseTo(143384.96, 6);
    expect(ary.datasets[0].data[10]).toBeCloseTo(167305.04, 6);
    expect(ary.datasets[0].data[11]).toBeCloseTo(188850.12, 6);
    expect(ary.datasets[0].data[12]).toBeCloseTo(189688.12, 6);
    expect(ary.datasets[0].data[13]).toBeCloseTo(189988.12, 6);
    expect(ary.datasets[0].data[14]).toBeCloseTo(193588.12, 6);
    expect(ary.datasets[0].data[15]).toBeCloseTo(197188.12, 6);
    expect(ary.datasets[0].data[16]).toBeCloseTo(200788.12, 6);
    expect(ary.datasets[0].data[17]).toBeCloseTo(204388.12, 6);
    expect(ary.datasets[0].data[18]).toBeCloseTo(207688.12, 6);
    expect(ary.datasets[0].data[19]).toBeCloseTo(209488.12, 6);
    expect(ary.datasets[0].data[20]).toBeCloseTo(211288.12, 6);
    expect(ary.datasets[0].data[21]).toBeCloseTo(213088.12, 6);
    expect(ary.datasets[0].data[22]).toBeCloseTo(214888.12, 6);
    expect(ary.datasets[0].data[23]).toBeCloseTo(216538.12, 6);
    expect(ary.datasets[0].data[24]).toBeCloseTo(216538.12, 6);
    expect(ary.datasets[0].data[25]).toBeCloseTo(216538.12, 6);
    expect(ary.datasets[0].data[26]).toBeCloseTo(216538.12, 6);
    expect(ary.datasets[0].data[27]).toBeCloseTo(216538.12, 6);
    ary = debtData;
    expect(ary.labels.length).toEqual(28);
    expect(ary.labels[0]).toEqual('Sun Jan 01 2017');
    expect(ary.labels[1]).toEqual('Mon Jan 01 2018');
    ...
    expect(ary.datasets[0].data[3]).toBeCloseTo(26177.04, 6);
    expect(ary.datasets[0].data[4]).toBeCloseTo(48854.28, 6);
    expect(ary.datasets[0].data[5]).toBeCloseTo(71670.08, 6);
    expect(ary.datasets[0].data[6]).toBeCloseTo(94569.68, 6);
    expect(ary.datasets[0].data[7]).toBeCloseTo(119374.6, 6);
    expect(ary.datasets[0].data[8]).toBeCloseTo(144494.68, 6);
    expect(ary.datasets[0].data[9]).toBeCloseTo(167114.76, 6);
    expect(ary.datasets[0].data[10]).toBeCloseTo(167952.76, 6);
    expect(ary.datasets[0].data[11]).toBeCloseTo(167952.76, 6);
    expect(ary.datasets[0].data[12]).toBeCloseTo(181159.12, 6);
    expect(ary.datasets[0].data[13]).toBeCloseTo(194695.63, 6);
    expect(ary.datasets[0].data[14]).toBeCloseTo(208570.56, 6);
    expect(ary.datasets[0].data[15]).toBeCloseTo(222792.36, 6);
    expect(ary.datasets[0].data[16]).toBeCloseTo(237369.71, 6);
    expect(ary.datasets[0].data[17]).toBeCloseTo(242794.39, 6);
    expect(ary.datasets[0].data[18]).toBeCloseTo(244893.79, 6);
    expect(ary.datasets[0].data[19]).toBeCloseTo(245738.65, 6);
    expect(ary.datasets[0].data[20]).toBeCloseTo(246091.37, 6);
    expect(ary.datasets[0].data[21]).toBeCloseTo(246243.8, 6);
    expect(ary.datasets[0].data[22]).toBeCloseTo(246311.86, 6);
    expect(ary.datasets[0].data[23]).toBeCloseTo(246343.2, 6);
    expect(ary.datasets[0].data[24]).toBeCloseTo(246358.06, 6);
    expect(ary.datasets[0].data[25]).toBeCloseTo(246365.3, 6);
    expect(ary.datasets[0].data[26]).toBeCloseTo(246368.93, 6);
    ...
    expect(ary.datasets[0].data[4]).toBeCloseTo(3366.36, 6);
    expect(ary.datasets[0].data[5]).toBeCloseTo(6212.37, 6);
    expect(ary.datasets[0].data[6]).toBeCloseTo(9100.56, 6);
    expect(ary.datasets[0].data[7]).toBeCloseTo(12050.04, 6);
    expect(ary.datasets[0].data[8]).toBeCloseTo(15007.29, 6);
    expect(ary.datasets[0].data[9]).toBeCloseTo(18282.59, 6);
    expect(ary.datasets[0].data[10]).toBeCloseTo(21721.41, 6);
    expect(ary.datasets[0].data[11]).toBeCloseTo(25158.2, 6);
    expect(ary.datasets[0].data[12]).toBeCloseTo(28592.9, 6);
