...
describe('Chrome Interaction', () => {
  ...
  it(
    'Should load the home page and get title',
  ...
  it('Should show a chart',
    () => new Promise(async (resolve, reject) => {
      ...
      const elts: WebElement[] = await driver.findElements(
        { id: chartID },
      );
  ...
  it(
    'Check asset chart data extends with bigger roi',
    async (done) => {
      if (!doActions) {
        done();
        return;
  ...
  it(
    'Check coarse, categorised, chart data',
    async (done) => {
      if (!doActions) {
        done();
        return;
  ...
  it(
    'Check fine, uncategorised, chart data',
    async (done) => {
  ...
  it(
    'Coarse asset view for cash asset, vals, +, -, +-',
    async (done) => {
      const modelAndRoi = getModelCoarseAndFine();
      await beforeAllWork(
        driver,
  ...
  it(
    'Fine asset view for selected category, vals',
    async (done) => {
      const modelAndRoi = getModelCoarseAndFine();
      await beforeAllWork(
        driver,
