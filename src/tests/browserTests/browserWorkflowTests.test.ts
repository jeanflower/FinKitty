...
describe(testDataModelName, () => {
  ...
  function assertAssetData(ary: any, createButtonID: string) {
    if (createButtonID === 'btn-create-Simple-example') {
      ...
      expect(ary[2].dataPoints[12].label).toEqual('Wed Jan 01 2031');
      expect(ary[2].dataPoints[12].y).toEqual(111189.5116357932);
      expect(ary[2].dataPoints[12].ttip).toEqual('111189.51 at Wed Jan 01 2031');
      expect(ary[2].dataPoints[13].label).toEqual('Thu Jan 01 2032');
      expect(ary[2].dataPoints[13].y).toEqual(104245.00459994566);
      expect(ary[2].dataPoints[13].ttip).toEqual('104245.00 at Thu Jan 01 2032');
      expect(ary[2].dataPoints[14].label).toEqual('Sat Jan 01 2033');
      expect(ary[2].dataPoints[14].y).toEqual(96251.70285379513);
      expect(ary[2].dataPoints[14].ttip).toEqual('96251.70 at Sat Jan 01 2033');
      expect(ary[2].dataPoints[15].label).toEqual('Sun Jan 01 2034');
      expect(ary[2].dataPoints[15].y).toEqual(87104.62014648736);
      expect(ary[2].dataPoints[15].ttip).toEqual('87104.62 at Sun Jan 01 2034');
      expect(ary[2].dataPoints[16].label).toEqual('Mon Jan 01 2035');
      ...
      expect(ary[3].dataPoints[16].y).toEqual(76689.05659641814);
      expect(ary[3].dataPoints[16].ttip).toEqual('76689.06 at Mon Jan 01 2035');
      expect(ary[3].dataPoints[17].label).toEqual('Tue Jan 01 2036');
      expect(ary[3].dataPoints[17].y).toEqual(62305.75485456013);
      expect(ary[3].dataPoints[17].ttip).toEqual('62305.75 at Tue Jan 01 2036');
      expect(ary[3].dataPoints[18].label).toEqual('Thu Jan 01 2037');
      expect(ary[3].dataPoints[18].y).toEqual(48734.135097952734);
      expect(ary[3].dataPoints[18].ttip).toEqual('48734.14 at Thu Jan 01 2037');
      expect(ary[3].dataPoints[19].label).toEqual('Fri Jan 01 2038');
      expect(ary[3].dataPoints[19].y).toEqual(33461.59112091265);
      expect(ary[3].dataPoints[19].ttip).toEqual('33461.59 at Fri Jan 01 2038');
      expect(ary[3].dataPoints[20].label).toEqual('Sat Jan 01 2039');
      expect(ary[3].dataPoints[20].y).toEqual(16323.052782542542);
      expect(ary[3].dataPoints[20].ttip).toEqual('16323.05 at Sat Jan 01 2039');
