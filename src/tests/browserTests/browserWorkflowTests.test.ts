...
describe('BrowserWorkflowTests', () => {
  ...
  function assertAssetData(ary: any, createButtonID: string) {
    if (createButtonID === 'btn-create-Simple-example') {
      ...
      expect(ary[0].dataPoints[4].y).toEqual(30314.94063005839);
      expect(ary[0].dataPoints[4].ttip).toEqual('30314.94 at Fri Jan 01 2021');
      expect(ary[0].dataPoints[5].label).toEqual('Sat Jan 01 2022');
      expect(ary[0].dataPoints[5].y).toEqual(54948.98762932004);
      expect(ary[0].dataPoints[5].ttip).toEqual('54948.99 at Sat Jan 01 2022');
      expect(ary[0].dataPoints[6].label).toEqual('Sun Jan 01 2023');
      expect(ary[0].dataPoints[6].y).toEqual(78964.21396686617);
      expect(ary[0].dataPoints[6].ttip).toEqual('78964.21 at Sun Jan 01 2023');
      expect(ary[0].dataPoints[7].label).toEqual('Mon Jan 01 2024');
      expect(ary[0].dataPoints[7].y).toEqual(103478.56295975362);
      expect(ary[0].dataPoints[7].ttip).toEqual('103478.56 at Mon Jan 01 2024');
      expect(ary[0].dataPoints[8].label).toEqual('Wed Jan 01 2025');
      expect(ary[0].dataPoints[8].y).toEqual(128502.43831269881);
      expect(ary[0].dataPoints[8].ttip).toEqual('128502.44 at Wed Jan 01 2025');
      expect(ary[0].dataPoints[9].label).toEqual('Thu Jan 01 2026');
      expect(ary[0].dataPoints[9].y).toEqual(154046.536452408);
      expect(ary[0].dataPoints[9].ttip).toEqual('154046.54 at Thu Jan 01 2026');
      expect(ary[0].dataPoints[10].label).toEqual('Fri Jan 01 2027');
      expect(ary[0].dataPoints[10].y).toEqual(180121.76923160895);
      expect(ary[0].dataPoints[10].ttip).toEqual('180121.77 at Fri Jan 01 2027');
      expect(ary[0].dataPoints[11].label).toEqual('Sat Jan 01 2028');
      expect(ary[0].dataPoints[11].y).toEqual(203956.5177051286);
      expect(ary[0].dataPoints[11].ttip).toEqual('203956.52 at Sat Jan 01 2028');
      expect(ary[0].dataPoints[12].label).toEqual('Mon Jan 01 2029');
      expect(ary[0].dataPoints[12].y).toEqual(203442.11556227456);
      ...
      expect(ary[0].dataPoints[13].y).toEqual(203807.813888273);
      ...
      expect(ary[0].dataPoints[14].y).toEqual(208243.59075363126);
      ...
      expect(ary[0].dataPoints[15].y).toEqual(212768.08315629675);
      ...
      expect(ary[0].dataPoints[16].y).toEqual(217383.06540701556);
      ...
      expect(ary[0].dataPoints[17].y).toEqual(222090.34730274868);
      ...
      expect(ary[0].dataPoints[18].y).toEqual(226488.0143348992);
      ...
      expect(ary[0].dataPoints[19].y).toEqual(228932.7047720446);
      ...
      expect(ary[0].dataPoints[20].y).toEqual(231426.28901793298);
      ...
      expect(ary[0].dataPoints[21].y).toEqual(233969.74494873907);
      ...
      expect(ary[0].dataPoints[22].y).toEqual(236564.06999816129);
      ...
      expect(ary[0].dataPoints[23].y).toEqual(238987.75695663044);
      ...
      expect(ary[0].dataPoints[24].y).toEqual(238987.75695663044);
      ...
      expect(ary[0].dataPoints[25].y).toEqual(238987.75695663044);
      ...
      expect(ary[0].dataPoints[26].y).toEqual(238987.75695663044);
      ...
      expect(ary[0].dataPoints[27].y).toEqual(238987.75695663044);
      ...
      expect(ary[0].dataPoints[3].label).toEqual('Sat Jan 01 2022');
      expect(ary[0].dataPoints[3].y).toEqual(29467.47058835764);
      expect(ary[0].dataPoints[3].ttip).toEqual('29467.47 at Sat Jan 01 2022');
      expect(ary[0].dataPoints[4].label).toEqual('Sun Jan 01 2023');
      expect(ary[0].dataPoints[4].y).toEqual(53482.68892648257);
      expect(ary[0].dataPoints[4].ttip).toEqual('53482.69 at Sun Jan 01 2023');
      expect(ary[0].dataPoints[5].label).toEqual('Mon Jan 01 2024');
      expect(ary[0].dataPoints[5].y).toEqual(77997.03791937002);
      expect(ary[0].dataPoints[5].ttip).toEqual('77997.04 at Mon Jan 01 2024');
      expect(ary[0].dataPoints[6].label).toEqual('Wed Jan 01 2025');
      expect(ary[0].dataPoints[6].y).toEqual(103020.91327231521);
      expect(ary[0].dataPoints[6].ttip).toEqual('103020.91 at Wed Jan 01 2025');
      expect(ary[0].dataPoints[7].label).toEqual('Thu Jan 01 2026');
      expect(ary[0].dataPoints[7].y).toEqual(128565.01141202435);
      expect(ary[0].dataPoints[7].ttip).toEqual('128565.01 at Thu Jan 01 2026');
      expect(ary[0].dataPoints[8].label).toEqual('Fri Jan 01 2027');
      expect(ary[0].dataPoints[8].y).toEqual(154640.24419122533);
      expect(ary[0].dataPoints[8].ttip).toEqual('154640.24 at Fri Jan 01 2027');
      expect(ary[0].dataPoints[9].label).toEqual('Sat Jan 01 2028');
      expect(ary[0].dataPoints[9].y).toEqual(178474.99266474496);
      expect(ary[0].dataPoints[9].ttip).toEqual('178474.99 at Sat Jan 01 2028');
      expect(ary[0].dataPoints[10].label).toEqual('Mon Jan 01 2029');
      expect(ary[0].dataPoints[10].y).toEqual(177960.59052189093);
      expect(ary[0].dataPoints[10].ttip).toEqual('177960.59 at Mon Jan 01 2029');
      expect(ary[0].dataPoints[11].label).toEqual('Tue Jan 01 2030');
      expect(ary[0].dataPoints[11].y).toEqual(177960.59052189093);
      expect(ary[0].dataPoints[11].ttip).toEqual('177960.59 at Tue Jan 01 2030');
      expect(ary[0].dataPoints[12].label).toEqual('Wed Jan 01 2031');
      expect(ary[0].dataPoints[12].y).toEqual(193961.6473243454);
      expect(ary[0].dataPoints[12].ttip).toEqual('193961.65 at Wed Jan 01 2031');
      expect(ary[0].dataPoints[13].label).toEqual('Thu Jan 01 2032');
      expect(ary[0].dataPoints[13].y).toEqual(210362.73054686122);
      expect(ary[0].dataPoints[13].ttip).toEqual('210362.73 at Thu Jan 01 2032');
      expect(ary[0].dataPoints[14].label).toEqual('Sat Jan 01 2033');
      expect(ary[0].dataPoints[14].y).toEqual(227173.84084993994);
      expect(ary[0].dataPoints[14].ttip).toEqual('227173.84 at Sat Jan 01 2033');
      expect(ary[0].dataPoints[15].label).toEqual('Sun Jan 01 2034');
      expect(ary[0].dataPoints[15].y).toEqual(244405.22891059562);
      expect(ary[0].dataPoints[15].ttip).toEqual('244405.23 at Sun Jan 01 2034');
      expect(ary[0].dataPoints[16].label).toEqual('Mon Jan 01 2035');
      expect(ary[0].dataPoints[16].y).toEqual(262067.40167276768);
      ...
      expect(ary[0].dataPoints[4].label).toEqual('Fri Jan 01 2021');
      expect(ary[0].dataPoints[4].y).toEqual(3891.8790584173134);
      expect(ary[0].dataPoints[4].ttip).toEqual('3891.88 at Fri Jan 01 2021');
      expect(ary[0].dataPoints[5].label).toEqual('Sat Jan 01 2022');
      expect(ary[0].dataPoints[5].y).toEqual(6042.056533678614);
      expect(ary[0].dataPoints[5].ttip).toEqual('6042.06 at Sat Jan 01 2022');
      expect(ary[0].dataPoints[6].label).toEqual('Sun Jan 01 2023');
      expect(ary[0].dataPoints[6].y).toEqual(7642.168926711267);
      expect(ary[0].dataPoints[6].ttip).toEqual('7642.17 at Sun Jan 01 2023');
      expect(ary[0].dataPoints[7].label).toEqual('Mon Jan 01 2024');
      expect(ary[0].dataPoints[7].y).toEqual(8633.172690276293);
      expect(ary[0].dataPoints[7].ttip).toEqual('8633.17 at Mon Jan 01 2024');
      expect(ary[0].dataPoints[8].label).toEqual('Wed Jan 01 2025');
      expect(ary[0].dataPoints[8].y).toEqual(8951.171938189997);
      expect(ary[0].dataPoints[8].ttip).toEqual('8951.17 at Wed Jan 01 2025');
      expect(ary[0].dataPoints[9].label).toEqual('Thu Jan 01 2026');
      expect(ary[0].dataPoints[9].y).toEqual(8526.971899330554);
      expect(ary[0].dataPoints[9].ttip).toEqual('8526.97 at Thu Jan 01 2026');
      expect(ary[0].dataPoints[10].label).toEqual('Fri Jan 01 2027');
      expect(ary[0].dataPoints[10].y).toEqual(7285.813852680822);
      expect(ary[0].dataPoints[10].ttip).toEqual('7285.81 at Fri Jan 01 2027');
      expect(ary[0].dataPoints[11].label).toEqual('Sat Jan 01 2028');
      expect(ary[0].dataPoints[11].y).toEqual(5146.739397534626);
      expect(ary[0].dataPoints[11].ttip).toEqual('5146.74 at Sat Jan 01 2028');
      expect(ary[0].dataPoints[12].label).toEqual('Mon Jan 01 2029');
      expect(ary[0].dataPoints[12].y).toEqual(2022.3117518797956);
      expect(ary[0].dataPoints[12].ttip).toEqual('2022.31 at Mon Jan 01 2029');
