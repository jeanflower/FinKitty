...
describe(testDataModelName, () => {
  ...
  function assertAssetData(ary: any, createButtonID: string) {
    if (createButtonID === 'btn-create-Simple-example') {
      ...
      expect(ary[2].name).toEqual(`${pension}Aegon`);
      expect(ary[2].type).toEqual('stackedColumn');
      expect(ary[2].showInLegend).toEqual(true);
      ...
      expect(ary[2].dataPoints[2].label).toEqual('Fri Jan 01 2021');
      expect(ary[2].dataPoints[2].y).toEqual(1402.5000000000011);
      expect(ary[2].dataPoints[2].ttip).toEqual('1402.50 at Fri Jan 01 2021');
      expect(ary[2].dataPoints[3].label).toEqual('Sat Jan 01 2022');
      expect(ary[2].dataPoints[3].y).toEqual(18824.213141790475);
      expect(ary[2].dataPoints[3].ttip).toEqual('18824.21 at Sat Jan 01 2022');
      expect(ary[2].dataPoints[4].label).toEqual('Sun Jan 01 2023');
      expect(ary[2].dataPoints[4].y).toEqual(37377.075387797355);
      expect(ary[2].dataPoints[4].ttip).toEqual('37377.08 at Sun Jan 01 2023');
      expect(ary[2].dataPoints[5].label).toEqual('Mon Jan 01 2024');
      expect(ary[2].dataPoints[5].y).toEqual(57118.93188796712);
      expect(ary[2].dataPoints[5].ttip).toEqual('57118.93 at Mon Jan 01 2024');
      expect(ary[2].dataPoints[6].label).toEqual('Wed Jan 01 2025');
      expect(ary[2].dataPoints[6].y).toEqual(78110.3696927989);
      expect(ary[2].dataPoints[6].ttip).toEqual('78110.37 at Wed Jan 01 2025');
      expect(ary[2].dataPoints[7].label).toEqual('Thu Jan 01 2026');
      expect(ary[2].dataPoints[7].y).toEqual(100414.84391624565);
      expect(ary[2].dataPoints[7].ttip).toEqual('100414.84 at Thu Jan 01 2026');
      expect(ary[2].dataPoints[8].label).toEqual('Fri Jan 01 2027');
      expect(ary[2].dataPoints[8].y).toEqual(124098.80963149293);
      expect(ary[2].dataPoints[8].ttip).toEqual('124098.81 at Fri Jan 01 2027');
      expect(ary[2].dataPoints[9].label).toEqual('Sat Jan 01 2028');
      expect(ary[2].dataPoints[9].y).toEqual(147620.82810982852);
      expect(ary[2].dataPoints[9].ttip).toEqual('147620.83 at Sat Jan 01 2028');
      expect(ary[2].dataPoints[10].label).toEqual('Mon Jan 01 2029');
      expect(ary[2].dataPoints[10].y).toEqual(154263.76537477088);
      expect(ary[2].dataPoints[10].ttip).toEqual('154263.77 at Mon Jan 01 2029');
      expect(ary[2].dataPoints[11].label).toEqual('Tue Jan 01 2030');
      ...
      expect(ary[3].name).toEqual(`${crystallizedPension}Joe`);
      ...
      expect(ary[3].dataPoints[11].y).toEqual(120904.22611247684);
      expect(ary[3].dataPoints[11].ttip).toEqual('120904.23 at Tue Jan 01 2030');
      expect(ary[3].dataPoints[12].label).toEqual('Wed Jan 01 2031');
      expect(ary[3].dataPoints[12].y).toEqual(111189.5116357932);
      expect(ary[3].dataPoints[12].ttip).toEqual('111189.51 at Wed Jan 01 2031');
      expect(ary[3].dataPoints[13].label).toEqual('Thu Jan 01 2032');
      expect(ary[3].dataPoints[13].y).toEqual(104245.00459994566);
      expect(ary[3].dataPoints[13].ttip).toEqual('104245.00 at Thu Jan 01 2032');
      expect(ary[3].dataPoints[14].label).toEqual('Sat Jan 01 2033');
      expect(ary[3].dataPoints[14].y).toEqual(96251.70285379513);
      expect(ary[3].dataPoints[14].ttip).toEqual('96251.70 at Sat Jan 01 2033');
      expect(ary[3].dataPoints[15].label).toEqual('Sun Jan 01 2034');
      expect(ary[3].dataPoints[15].y).toEqual(87104.62014648736);
      expect(ary[3].dataPoints[15].ttip).toEqual('87104.62 at Sun Jan 01 2034');
      expect(ary[3].dataPoints[16].label).toEqual('Mon Jan 01 2035');
      expect(ary[3].dataPoints[16].y).toEqual(0);
      expect(ary[3].dataPoints[16].ttip).toEqual('0.00 at Mon Jan 01 2035');
      expect(ary[3].dataPoints[17].label).toEqual('Tue Jan 01 2036');
      expect(ary[3].dataPoints[17].y).toEqual(0);
      expect(ary[3].dataPoints[17].ttip).toEqual('0.00 at Tue Jan 01 2036');
      expect(ary[3].dataPoints[18].label).toEqual('Thu Jan 01 2037');
      expect(ary[3].dataPoints[18].y).toEqual(0);
      expect(ary[3].dataPoints[18].ttip).toEqual('0.00 at Thu Jan 01 2037');
      expect(ary[3].dataPoints[19].label).toEqual('Fri Jan 01 2038');
      expect(ary[3].dataPoints[19].y).toEqual(0);
      expect(ary[3].dataPoints[19].ttip).toEqual('0.00 at Fri Jan 01 2038');
      ...
      expect(ary[4].name).toEqual(`${crystallizedPension}Jack`);
      ...
      expect(ary[4].dataPoints[16].y).toEqual(76689.05659641814);
      expect(ary[4].dataPoints[16].ttip).toEqual('76689.06 at Mon Jan 01 2035');
      expect(ary[4].dataPoints[17].label).toEqual('Tue Jan 01 2036');
      expect(ary[4].dataPoints[17].y).toEqual(62305.75485456013);
      expect(ary[4].dataPoints[17].ttip).toEqual('62305.75 at Tue Jan 01 2036');
      expect(ary[4].dataPoints[18].label).toEqual('Thu Jan 01 2037');
      expect(ary[4].dataPoints[18].y).toEqual(48734.135097952734);
      expect(ary[4].dataPoints[18].ttip).toEqual('48734.14 at Thu Jan 01 2037');
      expect(ary[4].dataPoints[19].label).toEqual('Fri Jan 01 2038');
      expect(ary[4].dataPoints[19].y).toEqual(33461.59112091265);
      expect(ary[4].dataPoints[19].ttip).toEqual('33461.59 at Fri Jan 01 2038');
      expect(ary[4].dataPoints[20].label).toEqual('Sat Jan 01 2039');
      expect(ary[4].dataPoints[20].y).toEqual(16323.052782542542);
      expect(ary[4].dataPoints[20].ttip).toEqual('16323.05 at Sat Jan 01 2039');
      ...
      expect(ary[0].dataPoints[12].label).toEqual('Wed Jan 01 2031');
      expect(ary[0].dataPoints[12].y).toEqual(192623.84321110384);
      expect(ary[0].dataPoints[12].ttip).toEqual('192623.84 at Wed Jan 01 2031');
      expect(ary[0].dataPoints[13].label).toEqual('Thu Jan 01 2032');
      expect(ary[0].dataPoints[13].y).toEqual(204183.8814444768);
      expect(ary[0].dataPoints[13].ttip).toEqual('204183.88 at Thu Jan 01 2032');
      expect(ary[0].dataPoints[14].label).toEqual('Sat Jan 01 2033');
      expect(ary[0].dataPoints[14].y).toEqual(216456.30145440303);
      expect(ary[0].dataPoints[14].ttip).toEqual('216456.30 at Sat Jan 01 2033');
      expect(ary[0].dataPoints[15].label).toEqual('Sun Jan 01 2034');
      expect(ary[0].dataPoints[15].y).toEqual(229497.01705916104);
      expect(ary[0].dataPoints[15].ttip).toEqual('229497.02 at Sun Jan 01 2034');
      expect(ary[0].dataPoints[16].label).toEqual('Mon Jan 01 2035');
      expect(ary[0].dataPoints[16].y).toEqual(243366.76930713415);
      expect(ary[0].dataPoints[16].ttip).toEqual('243366.77 at Mon Jan 01 2035');
      expect(ary[0].dataPoints[17].label).toEqual('Tue Jan 01 2036');
      expect(ary[0].dataPoints[17].y).toEqual(260621.93270573244);
      expect(ary[0].dataPoints[17].ttip).toEqual('260621.93 at Tue Jan 01 2036');
      expect(ary[0].dataPoints[18].label).toEqual('Thu Jan 01 2037');
      expect(ary[0].dataPoints[18].y).toEqual(276465.5424043692);
      expect(ary[0].dataPoints[18].ttip).toEqual('276465.54 at Thu Jan 01 2037');
      expect(ary[0].dataPoints[19].label).toEqual('Fri Jan 01 2038');
      expect(ary[0].dataPoints[19].y).toEqual(293363.9505707182);
      expect(ary[0].dataPoints[19].ttip).toEqual('293363.95 at Fri Jan 01 2038');
      expect(ary[0].dataPoints[20].label).toEqual('Sat Jan 01 2039');
      expect(ary[0].dataPoints[20].y).toEqual(311402.8109067444);
      expect(ary[0].dataPoints[20].ttip).toEqual('311402.81 at Sat Jan 01 2039');
      expect(ary[0].dataPoints[21].label).toEqual('Sun Jan 01 2040');
      expect(ary[0].dataPoints[21].y).toEqual(327906.4781132429);
      expect(ary[0].dataPoints[21].ttip).toEqual('327906.48 at Sun Jan 01 2040');
      expect(ary[0].dataPoints[22].label).toEqual('Tue Jan 01 2041');
      expect(ary[0].dataPoints[22].y).toEqual(327906.4781132429);
      expect(ary[0].dataPoints[22].ttip).toEqual('327906.48 at Tue Jan 01 2041');
      expect(ary[0].dataPoints[23].label).toEqual('Wed Jan 01 2042');
      expect(ary[0].dataPoints[23].y).toEqual(327906.4781132429);
      expect(ary[0].dataPoints[23].ttip).toEqual('327906.48 at Wed Jan 01 2042');
      expect(ary[0].dataPoints[24].label).toEqual('Thu Jan 01 2043');
      expect(ary[0].dataPoints[24].y).toEqual(327906.4781132429);
      expect(ary[0].dataPoints[24].ttip).toEqual('327906.48 at Thu Jan 01 2043');
      expect(ary[0].dataPoints[25].label).toEqual('Fri Jan 01 2044');
      expect(ary[0].dataPoints[25].y).toEqual(327906.4781132429);
      expect(ary[0].dataPoints[25].ttip).toEqual('327906.48 at Fri Jan 01 2044');
      expect(ary[0].dataPoints[26].label).toEqual('Sun Jan 01 2045');
      expect(ary[0].dataPoints[26].y).toEqual(327906.4781132429);
      expect(ary[0].dataPoints[26].ttip).toEqual('327906.48 at Sun Jan 01 2045');
      expect(ary[1].name).toEqual(`Aegon${taxFree}`);
      expect(ary[1].type).toEqual('stackedColumn');
      expect(ary[1].showInLegend).toEqual(true);
      ...
      expect(ary[1].dataPoints[11].label).toEqual('Tue Jan 01 2030');
      expect(ary[1].dataPoints[11].y).toEqual(40301.408704158945);
      expect(ary[1].dataPoints[11].ttip).toEqual('40301.41 at Tue Jan 01 2030');
      expect(ary[1].dataPoints[12].label).toEqual('Wed Jan 01 2031');
      expect(ary[1].dataPoints[12].y).toEqual(42114.97209584614);
      expect(ary[1].dataPoints[12].ttip).toEqual('42114.97 at Wed Jan 01 2031');
      expect(ary[1].dataPoints[13].label).toEqual('Thu Jan 01 2032');
      expect(ary[1].dataPoints[13].y).toEqual(44010.14584015927);
      expect(ary[1].dataPoints[13].ttip).toEqual('44010.15 at Thu Jan 01 2032');
      expect(ary[1].dataPoints[14].label).toEqual('Sat Jan 01 2033');
      expect(ary[1].dataPoints[14].y).toEqual(45990.60240296647);
      expect(ary[1].dataPoints[14].ttip).toEqual('45990.60 at Sat Jan 01 2033');
      expect(ary[1].dataPoints[15].label).toEqual('Sun Jan 01 2034');
      expect(ary[1].dataPoints[15].y).toEqual(48060.17951110002);
      expect(ary[1].dataPoints[15].ttip).toEqual('48060.18 at Sun Jan 01 2034');
      expect(ary[1].dataPoints[16].label).toEqual('Mon Jan 01 2035');
      expect(ary[1].dataPoints[16].y).toEqual(50222.88758909957);
      expect(ary[1].dataPoints[16].ttip).toEqual('50222.89 at Mon Jan 01 2035');
      expect(ary[1].dataPoints[17].label).toEqual('Tue Jan 01 2036');
      expect(ary[1].dataPoints[17].y).toEqual(52482.9175306091);
      expect(ary[1].dataPoints[17].ttip).toEqual('52482.92 at Tue Jan 01 2036');
      expect(ary[1].dataPoints[18].label).toEqual('Thu Jan 01 2037');
      expect(ary[1].dataPoints[18].y).toEqual(54844.648819486574);
      expect(ary[1].dataPoints[18].ttip).toEqual('54844.65 at Thu Jan 01 2037');
      expect(ary[1].dataPoints[19].label).toEqual('Fri Jan 01 2038');
      expect(ary[1].dataPoints[19].y).toEqual(57312.65801636352);
      expect(ary[1].dataPoints[19].ttip).toEqual('57312.66 at Fri Jan 01 2038');
      expect(ary[1].dataPoints[20].label).toEqual('Sat Jan 01 2039');
      expect(ary[1].dataPoints[20].y).toEqual(59891.72762709994);
      expect(ary[1].dataPoints[20].ttip).toEqual('59891.73 at Sat Jan 01 2039');
      expect(ary[1].dataPoints[21].label).toEqual('Sun Jan 01 2040');
      expect(ary[1].dataPoints[21].y).toEqual(62586.85537031951);
      expect(ary[1].dataPoints[21].ttip).toEqual('62586.86 at Sun Jan 01 2040');
      expect(ary[1].dataPoints[22].label).toEqual('Tue Jan 01 2041');
      expect(ary[1].dataPoints[22].y).toEqual(65403.26386198394);
      expect(ary[1].dataPoints[22].ttip).toEqual('65403.26 at Tue Jan 01 2041');
      expect(ary[1].dataPoints[23].label).toEqual('Wed Jan 01 2042');
      expect(ary[1].dataPoints[23].y).toEqual(68346.4107357733);
      expect(ary[1].dataPoints[23].ttip).toEqual('68346.41 at Wed Jan 01 2042');
      expect(ary[1].dataPoints[24].label).toEqual('Thu Jan 01 2043');
      expect(ary[1].dataPoints[24].y).toEqual(71421.99921888315);
      expect(ary[1].dataPoints[24].ttip).toEqual('71422.00 at Thu Jan 01 2043');
      expect(ary[1].dataPoints[25].label).toEqual('Fri Jan 01 2044');
      expect(ary[1].dataPoints[25].y).toEqual(74635.98918373296);
      expect(ary[1].dataPoints[25].ttip).toEqual('74635.99 at Fri Jan 01 2044');
      expect(ary[1].dataPoints[26].label).toEqual('Sun Jan 01 2045');
      expect(ary[1].dataPoints[26].y).toEqual(77994.60869700105);
      expect(ary[1].dataPoints[26].ttip).toEqual('77994.61 at Sun Jan 01 2045');
    } else if (
