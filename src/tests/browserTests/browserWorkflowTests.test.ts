...
describe('BrowserWorkflowTests', () => {
  ...
  function assertAssetData(ary: any, createButtonID: string) {
    if (createButtonID === 'btn-create-Simple-example') {
      ...
      expect(ary[0].dataPoints[2].y).toEqual(16152.45855510903);
      expect(ary[0].dataPoints[2].ttip).toEqual('16152.46 at Fri Jan 01 2021');
      expect(ary[0].dataPoints[3].label).toEqual('Sat Jan 01 2022');
      expect(ary[0].dataPoints[3].y).toEqual(21754.93195886315);
      expect(ary[0].dataPoints[3].ttip).toEqual('21754.93 at Sat Jan 01 2022');
      expect(ary[0].dataPoints[4].label).toEqual('Sun Jan 01 2023');
      expect(ary[0].dataPoints[4].y).toEqual(27888.187193171027);
      expect(ary[0].dataPoints[4].ttip).toEqual('27888.19 at Sun Jan 01 2023');
      expect(ary[0].dataPoints[5].label).toEqual('Mon Jan 01 2024');
      expect(ary[0].dataPoints[5].y).toEqual(34547.55754279061);
      expect(ary[0].dataPoints[5].ttip).toEqual('34547.56 at Mon Jan 01 2024');
      expect(ary[0].dataPoints[6].label).toEqual('Wed Jan 01 2025');
      expect(ary[0].dataPoints[6].y).toEqual(41725.42082279788);
      expect(ary[0].dataPoints[6].ttip).toEqual('41725.42 at Wed Jan 01 2025');
      expect(ary[0].dataPoints[7].label).toEqual('Thu Jan 01 2026');
      expect(ary[0].dataPoints[7].y).toEqual(51583.38301598833);
      expect(ary[0].dataPoints[7].ttip).toEqual('51583.38 at Thu Jan 01 2026');
      expect(ary[0].dataPoints[8].label).toEqual('Fri Jan 01 2027');
      expect(ary[0].dataPoints[8].y).toEqual(74987.57372530254);
      expect(ary[0].dataPoints[8].ttip).toEqual('74987.57 at Fri Jan 01 2027');
      expect(ary[0].dataPoints[9].label).toEqual('Sat Jan 01 2028');
      expect(ary[0].dataPoints[9].y).toEqual(101643.51149447552);
      expect(ary[0].dataPoints[9].ttip).toEqual('101643.51 at Sat Jan 01 2028');
      expect(ary[0].dataPoints[10].label).toEqual('Mon Jan 01 2029');
      expect(ary[0].dataPoints[10].y).toEqual(128677.12632647961);
      expect(ary[0].dataPoints[10].ttip).toEqual('128677.13 at Mon Jan 01 2029');
      expect(ary[0].dataPoints[11].label).toEqual('Tue Jan 01 2030');
      expect(ary[0].dataPoints[11].y).toEqual(139551.75028698822);
      expect(ary[0].dataPoints[11].ttip).toEqual('139551.75 at Tue Jan 01 2030');
      expect(ary[0].dataPoints[12].label).toEqual('Wed Jan 01 2031');
      expect(ary[0].dataPoints[12].y).toEqual(145351.51397374447);
      expect(ary[0].dataPoints[12].ttip).toEqual('145351.51 at Wed Jan 01 2031');
      expect(ary[0].dataPoints[13].label).toEqual('Thu Jan 01 2032');
      expect(ary[0].dataPoints[13].y).toEqual(151999.19941765908);
      expect(ary[0].dataPoints[13].ttip).toEqual('151999.20 at Thu Jan 01 2032');
      expect(ary[0].dataPoints[14].label).toEqual('Sat Jan 01 2033');
      expect(ary[0].dataPoints[14].y).toEqual(159539.4596831453);
      expect(ary[0].dataPoints[14].ttip).toEqual('159539.46 at Sat Jan 01 2033');
      expect(ary[0].dataPoints[15].label).toEqual('Sun Jan 01 2034');
      expect(ary[0].dataPoints[15].y).toEqual(171069.6436808383);
      expect(ary[0].dataPoints[15].ttip).toEqual('171069.64 at Sun Jan 01 2034');
      expect(ary[0].dataPoints[16].label).toEqual('Mon Jan 01 2035');
      expect(ary[0].dataPoints[16].y).toEqual(198818.2812988561);
      expect(ary[0].dataPoints[16].ttip).toEqual('198818.28 at Mon Jan 01 2035');
      expect(ary[0].dataPoints[17].label).toEqual('Tue Jan 01 2036');
      expect(ary[0].dataPoints[17].y).toEqual(228062.3961519922);
      expect(ary[0].dataPoints[17].ttip).toEqual('228062.40 at Tue Jan 01 2036');
      expect(ary[0].dataPoints[18].label).toEqual('Thu Jan 01 2037');
      expect(ary[0].dataPoints[18].y).toEqual(258866.32569320564);
      expect(ary[0].dataPoints[18].ttip).toEqual('258866.33 at Thu Jan 01 2037');
      expect(ary[0].dataPoints[19].label).toEqual('Fri Jan 01 2038');
      expect(ary[0].dataPoints[19].y).toEqual(291297.04940925265);
      expect(ary[0].dataPoints[19].ttip).toEqual('291297.05 at Fri Jan 01 2038');
      expect(ary[0].dataPoints[20].label).toEqual('Sat Jan 01 2039');
      expect(ary[0].dataPoints[20].y).toEqual(325424.22633216216);
      expect(ary[0].dataPoints[20].ttip).toEqual('325424.23 at Sat Jan 01 2039');
      expect(ary[0].dataPoints[21].label).toEqual('Sun Jan 01 2040');
      expect(ary[0].dataPoints[21].y).toEqual(361320.3165506584);
      expect(ary[0].dataPoints[21].ttip).toEqual('361320.32 at Sun Jan 01 2040');
      expect(ary[0].dataPoints[22].label).toEqual('Tue Jan 01 2041');
      expect(ary[0].dataPoints[22].y).toEqual(399060.69805889827);
      expect(ary[0].dataPoints[22].ttip).toEqual('399060.70 at Tue Jan 01 2041');
      ...
      expect(ary[0].dataPoints[4].y).toEqual(27902.366751018315);
      expect(ary[0].dataPoints[4].ttip).toEqual('27902.37 at Fri Jan 01 2021');
      expect(ary[0].dataPoints[5].label).toEqual('Sat Jan 01 2022');
      expect(ary[0].dataPoints[5].y).toEqual(52505.57128282135);
      expect(ary[0].dataPoints[5].ttip).toEqual('52505.57 at Sat Jan 01 2022');
      expect(ary[0].dataPoints[6].label).toEqual('Sun Jan 01 2023');
      expect(ary[0].dataPoints[6].y).toEqual(76489.40288355971);
      expect(ary[0].dataPoints[6].ttip).toEqual('76489.40 at Sun Jan 01 2023');
      expect(ary[0].dataPoints[7].label).toEqual('Mon Jan 01 2024');
      expect(ary[0].dataPoints[7].y).toEqual(100971.83436940322);
      expect(ary[0].dataPoints[7].ttip).toEqual('100971.83 at Mon Jan 01 2024');
      expect(ary[0].dataPoints[8].label).toEqual('Wed Jan 01 2025');
      expect(ary[0].dataPoints[8].y).toEqual(125963.23161777611);
      expect(ary[0].dataPoints[8].ttip).toEqual('125963.23 at Wed Jan 01 2025');
      expect(ary[0].dataPoints[9].label).toEqual('Thu Jan 01 2026');
      expect(ary[0].dataPoints[9].y).toEqual(151474.29607224933);
      expect(ary[0].dataPoints[9].ttip).toEqual('151474.30 at Thu Jan 01 2026');
      expect(ary[0].dataPoints[10].label).toEqual('Fri Jan 01 2027');
      expect(ary[0].dataPoints[10].y).toEqual(177515.9476184732);
      expect(ary[0].dataPoints[10].ttip).toEqual('177515.95 at Fri Jan 01 2027');
      expect(ary[0].dataPoints[11].label).toEqual('Sat Jan 01 2028');
      expect(ary[0].dataPoints[11].y).toEqual(201316.53853346876);
      expect(ary[0].dataPoints[11].ttip).toEqual('201316.54 at Sat Jan 01 2028');
      expect(ary[0].dataPoints[12].label).toEqual('Mon Jan 01 2029');
      expect(ary[0].dataPoints[12].y).toEqual(202331.84883526617);
      expect(ary[0].dataPoints[12].ttip).toEqual('202331.85 at Mon Jan 01 2029');
      expect(ary[0].dataPoints[13].label).toEqual('Tue Jan 01 2030');
      expect(ary[0].dataPoints[13].y).toEqual(202697.5471612646);
      expect(ary[0].dataPoints[13].ttip).toEqual('202697.55 at Tue Jan 01 2030');
      expect(ary[0].dataPoints[14].label).toEqual('Wed Jan 01 2031');
      expect(ary[0].dataPoints[14].y).toEqual(207133.32402662287);
      expect(ary[0].dataPoints[14].ttip).toEqual('207133.32 at Wed Jan 01 2031');
      expect(ary[0].dataPoints[15].label).toEqual('Thu Jan 01 2032');
      expect(ary[0].dataPoints[15].y).toEqual(211657.81642928836);
      expect(ary[0].dataPoints[15].ttip).toEqual('211657.82 at Thu Jan 01 2032');
      expect(ary[0].dataPoints[16].label).toEqual('Sat Jan 01 2033');
      expect(ary[0].dataPoints[16].y).toEqual(216272.79868000717);
      expect(ary[0].dataPoints[16].ttip).toEqual('216272.80 at Sat Jan 01 2033');
      expect(ary[0].dataPoints[17].label).toEqual('Sun Jan 01 2034');
      expect(ary[0].dataPoints[17].y).toEqual(220980.08057574028);
      expect(ary[0].dataPoints[17].ttip).toEqual('220980.08 at Sun Jan 01 2034');
      expect(ary[0].dataPoints[18].label).toEqual('Mon Jan 01 2035');
      expect(ary[0].dataPoints[18].y).toEqual(225377.7476078908);
      expect(ary[0].dataPoints[18].ttip).toEqual('225377.75 at Mon Jan 01 2035');
      expect(ary[0].dataPoints[19].label).toEqual('Tue Jan 01 2036');
      expect(ary[0].dataPoints[19].y).toEqual(227822.43804503622);
      expect(ary[0].dataPoints[19].ttip).toEqual('227822.44 at Tue Jan 01 2036');
      expect(ary[0].dataPoints[20].label).toEqual('Thu Jan 01 2037');
      expect(ary[0].dataPoints[20].y).toEqual(230316.0222909246);
      expect(ary[0].dataPoints[20].ttip).toEqual('230316.02 at Thu Jan 01 2037');
      expect(ary[0].dataPoints[21].label).toEqual('Fri Jan 01 2038');
      expect(ary[0].dataPoints[21].y).toEqual(232859.47822173068);
      expect(ary[0].dataPoints[21].ttip).toEqual('232859.48 at Fri Jan 01 2038');
      expect(ary[0].dataPoints[22].label).toEqual('Sat Jan 01 2039');
      expect(ary[0].dataPoints[22].y).toEqual(235453.8032711529);
      expect(ary[0].dataPoints[22].ttip).toEqual('235453.80 at Sat Jan 01 2039');
      expect(ary[0].dataPoints[23].label).toEqual('Sun Jan 01 2040');
      expect(ary[0].dataPoints[23].y).toEqual(237877.49022962205);
      expect(ary[0].dataPoints[23].ttip).toEqual('237877.49 at Sun Jan 01 2040');
      expect(ary[0].dataPoints[24].label).toEqual('Tue Jan 01 2041');
      expect(ary[0].dataPoints[24].y).toEqual(237877.49022962205);
      expect(ary[0].dataPoints[24].ttip).toEqual('237877.49 at Tue Jan 01 2041');
      expect(ary[0].dataPoints[25].label).toEqual('Wed Jan 01 2042');
      expect(ary[0].dataPoints[25].y).toEqual(237877.49022962205);
      expect(ary[0].dataPoints[25].ttip).toEqual('237877.49 at Wed Jan 01 2042');
      expect(ary[0].dataPoints[26].label).toEqual('Thu Jan 01 2043');
      expect(ary[0].dataPoints[26].y).toEqual(237877.49022962205);
      expect(ary[0].dataPoints[26].ttip).toEqual('237877.49 at Thu Jan 01 2043');
      expect(ary[0].dataPoints[27].label).toEqual('Fri Jan 01 2044');
      expect(ary[0].dataPoints[27].y).toEqual(237877.49022962205);
      expect(ary[0].dataPoints[27].ttip).toEqual('237877.49 at Fri Jan 01 2044');
    } else if (
      ...
      expect(ary[0].dataPoints[3].label).toEqual('Sat Jan 01 2022');
      expect(ary[0].dataPoints[3].y).toEqual(27006.722231736763);
      expect(ary[0].dataPoints[3].ttip).toEqual('27006.72 at Sat Jan 01 2022');
      expect(ary[0].dataPoints[4].label).toEqual('Sun Jan 01 2023');
      expect(ary[0].dataPoints[4].y).toEqual(50990.54583305393);
      expect(ary[0].dataPoints[4].ttip).toEqual('50990.55 at Sun Jan 01 2023');
      expect(ary[0].dataPoints[5].label).toEqual('Mon Jan 01 2024');
      expect(ary[0].dataPoints[5].y).toEqual(75472.97731889745);
      expect(ary[0].dataPoints[5].ttip).toEqual('75472.98 at Mon Jan 01 2024');
      expect(ary[0].dataPoints[6].label).toEqual('Wed Jan 01 2025');
      expect(ary[0].dataPoints[6].y).toEqual(100464.37456727034);
      expect(ary[0].dataPoints[6].ttip).toEqual('100464.37 at Wed Jan 01 2025');
      expect(ary[0].dataPoints[7].label).toEqual('Thu Jan 01 2026');
      expect(ary[0].dataPoints[7].y).toEqual(125975.43902174354);
      expect(ary[0].dataPoints[7].ttip).toEqual('125975.44 at Thu Jan 01 2026');
      expect(ary[0].dataPoints[8].label).toEqual('Fri Jan 01 2027');
      expect(ary[0].dataPoints[8].y).toEqual(152017.09056796745);
      expect(ary[0].dataPoints[8].ttip).toEqual('152017.09 at Fri Jan 01 2027');
      expect(ary[0].dataPoints[9].label).toEqual('Sat Jan 01 2028');
      expect(ary[0].dataPoints[9].y).toEqual(175817.681482963);
      expect(ary[0].dataPoints[9].ttip).toEqual('175817.68 at Sat Jan 01 2028');
      expect(ary[0].dataPoints[10].label).toEqual('Mon Jan 01 2029');
      expect(ary[0].dataPoints[10].y).toEqual(176832.9917847604);
      expect(ary[0].dataPoints[10].ttip).toEqual('176832.99 at Mon Jan 01 2029');
      expect(ary[0].dataPoints[11].label).toEqual('Tue Jan 01 2030');
      expect(ary[0].dataPoints[11].y).toEqual(176832.9917847604);
      expect(ary[0].dataPoints[11].ttip).toEqual('176832.99 at Tue Jan 01 2030');
      expect(ary[0].dataPoints[12].label).toEqual('Wed Jan 01 2031');
      expect(ary[0].dataPoints[12].y).toEqual(192834.04858721487);
      expect(ary[0].dataPoints[12].ttip).toEqual('192834.05 at Wed Jan 01 2031');
      expect(ary[0].dataPoints[13].label).toEqual('Thu Jan 01 2032');
      expect(ary[0].dataPoints[13].y).toEqual(209235.1318097307);
      expect(ary[0].dataPoints[13].ttip).toEqual('209235.13 at Thu Jan 01 2032');
      expect(ary[0].dataPoints[14].label).toEqual('Sat Jan 01 2033');
      expect(ary[0].dataPoints[14].y).toEqual(226046.2421128094);
      expect(ary[0].dataPoints[14].ttip).toEqual('226046.24 at Sat Jan 01 2033');
      expect(ary[0].dataPoints[15].label).toEqual('Sun Jan 01 2034');
      expect(ary[0].dataPoints[15].y).toEqual(243277.6301734651);
      expect(ary[0].dataPoints[15].ttip).toEqual('243277.63 at Sun Jan 01 2034');
      expect(ary[0].dataPoints[16].label).toEqual('Mon Jan 01 2035');
      expect(ary[0].dataPoints[16].y).toEqual(260939.80293563716);
      expect(ary[0].dataPoints[16].ttip).toEqual('260939.80 at Mon Jan 01 2035');
      expect(ary[0].dataPoints[17].label).toEqual('Tue Jan 01 2036');
      expect(ary[0].dataPoints[17].y).toEqual(279043.5300168635);
      expect(ary[0].dataPoints[17].ttip).toEqual('279043.53 at Tue Jan 01 2036');
      expect(ary[0].dataPoints[18].label).toEqual('Thu Jan 01 2037');
      expect(ary[0].dataPoints[18].y).toEqual(297599.8502751205);
      expect(ary[0].dataPoints[18].ttip).toEqual('297599.85 at Thu Jan 01 2037');
      expect(ary[0].dataPoints[19].label).toEqual('Fri Jan 01 2038');
      expect(ary[0].dataPoints[19].y).toEqual(316620.078539834);
      expect(ary[0].dataPoints[19].ttip).toEqual('316620.08 at Fri Jan 01 2038');
      expect(ary[0].dataPoints[20].label).toEqual('Sat Jan 01 2039');
      expect(ary[0].dataPoints[20].y).toEqual(320158.0068592784);
      expect(ary[0].dataPoints[20].ttip).toEqual('320158.01 at Sat Jan 01 2039');
      expect(ary[0].dataPoints[21].label).toEqual('Sun Jan 01 2040');
      expect(ary[0].dataPoints[21].y).toEqual(320158.0068592784);
      expect(ary[0].dataPoints[21].ttip).toEqual('320158.01 at Sun Jan 01 2040');
      expect(ary[0].dataPoints[22].label).toEqual('Tue Jan 01 2041');
      expect(ary[0].dataPoints[22].y).toEqual(320158.0068592784);
      expect(ary[0].dataPoints[22].ttip).toEqual('320158.01 at Tue Jan 01 2041');
      expect(ary[0].dataPoints[23].label).toEqual('Wed Jan 01 2042');
      expect(ary[0].dataPoints[23].y).toEqual(320158.0068592784);
      expect(ary[0].dataPoints[23].ttip).toEqual('320158.01 at Wed Jan 01 2042');
      expect(ary[0].dataPoints[24].label).toEqual('Thu Jan 01 2043');
      expect(ary[0].dataPoints[24].y).toEqual(320158.0068592784);
      expect(ary[0].dataPoints[24].ttip).toEqual('320158.01 at Thu Jan 01 2043');
      expect(ary[0].dataPoints[25].label).toEqual('Fri Jan 01 2044');
      expect(ary[0].dataPoints[25].y).toEqual(320158.0068592784);
      expect(ary[0].dataPoints[25].ttip).toEqual('320158.01 at Fri Jan 01 2044');
      expect(ary[0].dataPoints[26].label).toEqual('Sun Jan 01 2045');
      expect(ary[0].dataPoints[26].y).toEqual(320158.0068592784);
      expect(ary[0].dataPoints[26].ttip).toEqual('320158.01 at Sun Jan 01 2045');
      ...
      expect(ary[0].dataPoints[4].label).toEqual('Fri Jan 01 2021');
      expect(ary[0].dataPoints[4].y).toEqual(3137.1190584173128);
      expect(ary[0].dataPoints[4].ttip).toEqual('3137.12 at Fri Jan 01 2021');
      expect(ary[0].dataPoints[5].label).toEqual('Sat Jan 01 2022');
      expect(ary[0].dataPoints[5].y).toEqual(5274.805818263784);
      expect(ary[0].dataPoints[5].ttip).toEqual('5274.81 at Sat Jan 01 2022');
      expect(ary[0].dataPoints[6].label).toEqual('Sun Jan 01 2023');
      expect(ary[0].dataPoints[6].y).toEqual(6862.115477996236);
      expect(ary[0].dataPoints[6].ttip).toEqual('6862.12 at Sun Jan 01 2023');
      expect(ary[0].dataPoints[7].label).toEqual('Mon Jan 01 2024');
      expect(ary[0].dataPoints[7].y).toEqual(7839.990189928554);
      expect(ary[0].dataPoints[7].ttip).toEqual('7839.99 at Mon Jan 01 2024');
      expect(ary[0].dataPoints[8].label).toEqual('Wed Jan 01 2025');
      expect(ary[0].dataPoints[8].y).toEqual(8144.501659918727);
      expect(ary[0].dataPoints[8].ttip).toEqual('8144.50 at Wed Jan 01 2025');
      expect(ary[0].dataPoints[9].label).toEqual('Thu Jan 01 2026');
      expect(ary[0].dataPoints[9].y).toEqual(7706.494898687665);
      expect(ary[0].dataPoints[9].ttip).toEqual('7706.49 at Thu Jan 01 2026');
      expect(ary[0].dataPoints[10].label).toEqual('Fri Jan 01 2027');
      expect(ary[0].dataPoints[10].y).toEqual(6451.20346160702);
      expect(ary[0].dataPoints[10].ttip).toEqual('6451.20 at Fri Jan 01 2027');
      expect(ary[0].dataPoints[11].label).toEqual('Sat Jan 01 2028');
      expect(ary[0].dataPoints[11].y).toEqual(4297.634031269134);
      expect(ary[0].dataPoints[11].ttip).toEqual('4297.63 at Sat Jan 01 2028');
      expect(ary[0].dataPoints[12].label).toEqual('Mon Jan 01 2029');
      expect(ary[0].dataPoints[12].y).toEqual(1158.338036042819);
      expect(ary[0].dataPoints[12].ttip).toEqual('1158.34 at Mon Jan 01 2029');
