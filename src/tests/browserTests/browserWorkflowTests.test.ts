...
describe('BrowserWorkflowTests', () => {
  ...
  function assertAssetData(ary: any, createButtonID: string) {
    if (createButtonID === 'btn-create-Simple-example') {
      ...
      expect(ary[0].dataPoints[4].y).toEqual(27479.52206419377);
      expect(ary[0].dataPoints[4].ttip).toEqual('27479.52 at Sun Jan 01 2023');
      expect(ary[0].dataPoints[5].label).toEqual('Mon Jan 01 2024');
      expect(ary[0].dataPoints[5].y).toEqual(33805.97286100654);
      expect(ary[0].dataPoints[5].ttip).toEqual('33805.97 at Mon Jan 01 2024');
      expect(ary[0].dataPoints[6].label).toEqual('Wed Jan 01 2025');
      expect(ary[0].dataPoints[6].y).toEqual(40419.606163372686);
      expect(ary[0].dataPoints[6].ttip).toEqual('40419.61 at Wed Jan 01 2025');
      expect(ary[0].dataPoints[7].label).toEqual('Thu Jan 01 2026');
      expect(ary[0].dataPoints[7].y).toEqual(49516.49142986299);
      expect(ary[0].dataPoints[7].ttip).toEqual('49516.49 at Thu Jan 01 2026');
      expect(ary[0].dataPoints[8].label).toEqual('Fri Jan 01 2027');
      expect(ary[0].dataPoints[8].y).toEqual(72135.18195928755);
      expect(ary[0].dataPoints[8].ttip).toEqual('72135.18 at Fri Jan 01 2027');
      expect(ary[0].dataPoints[9].label).toEqual('Sat Jan 01 2028');
      expect(ary[0].dataPoints[9].y).toEqual(97978.15152214596);
      expect(ary[0].dataPoints[9].ttip).toEqual('97978.15 at Sat Jan 01 2028');
      expect(ary[0].dataPoints[10].label).toEqual('Mon Jan 01 2029');
      expect(ary[0].dataPoints[10].y).toEqual(124159.89340149699);
      expect(ary[0].dataPoints[10].ttip).toEqual('124159.89 at Mon Jan 01 2029');
      expect(ary[0].dataPoints[11].label).toEqual('Tue Jan 01 2030');
      expect(ary[0].dataPoints[11].y).toEqual(134142.37566926886);
      expect(ary[0].dataPoints[11].ttip).toEqual('134142.38 at Tue Jan 01 2030');
      expect(ary[0].dataPoints[12].label).toEqual('Wed Jan 01 2031');
      expect(ary[0].dataPoints[12].y).toEqual(139008.1671948589);
      expect(ary[0].dataPoints[12].ttip).toEqual('139008.17 at Wed Jan 01 2031');
      expect(ary[0].dataPoints[13].label).toEqual('Thu Jan 01 2032');
      expect(ary[0].dataPoints[13].y).toEqual(144678.6203979053);
      expect(ary[0].dataPoints[13].ttip).toEqual('144678.62 at Thu Jan 01 2032');
      expect(ary[0].dataPoints[14].label).toEqual('Sat Jan 01 2033');
      expect(ary[0].dataPoints[14].y).toEqual(151196.6978635115);
      expect(ary[0].dataPoints[14].ttip).toEqual('151196.70 at Sat Jan 01 2033');
      expect(ary[0].dataPoints[15].label).toEqual('Sun Jan 01 2034');
      expect(ary[0].dataPoints[15].y).toEqual(161658.20660342666);
      expect(ary[0].dataPoints[15].ttip).toEqual('161658.21 at Sun Jan 01 2034');
      expect(ary[0].dataPoints[16].label).toEqual('Mon Jan 01 2035');
      expect(ary[0].dataPoints[16].y).toEqual(188289.9314879795);
      expect(ary[0].dataPoints[16].ttip).toEqual('188289.93 at Mon Jan 01 2035');
      expect(ary[0].dataPoints[17].label).toEqual('Tue Jan 01 2036');
      expect(ary[0].dataPoints[17].y).toEqual(216367.17561127787);
      expect(ary[0].dataPoints[17].ttip).toEqual('216367.18 at Tue Jan 01 2036');
      expect(ary[0].dataPoints[18].label).toEqual('Thu Jan 01 2037');
      expect(ary[0].dataPoints[18].y).toEqual(245952.46951075102);
      expect(ary[0].dataPoints[18].ttip).toEqual('245952.47 at Thu Jan 01 2037');
      expect(ary[0].dataPoints[19].label).toEqual('Fri Jan 01 2038');
      expect(ary[0].dataPoints[19].y).toEqual(277110.92720567284);
      expect(ary[0].dataPoints[19].ttip).toEqual('277110.93 at Fri Jan 01 2038');
      expect(ary[0].dataPoints[20].label).toEqual('Sat Jan 01 2039');
      expect(ary[0].dataPoints[20].y).toEqual(309910.2919678887);
      expect(ary[0].dataPoints[20].ttip).toEqual('309910.29 at Sat Jan 01 2039');
      expect(ary[0].dataPoints[21].label).toEqual('Sun Jan 01 2040');
      expect(ary[0].dataPoints[21].y).toEqual(344421.0563928767);
      expect(ary[0].dataPoints[21].ttip).toEqual('344421.06 at Sun Jan 01 2040');
      expect(ary[0].dataPoints[22].label).toEqual('Tue Jan 01 2041');
      expect(ary[0].dataPoints[22].y).toEqual(380716.546459691);
      expect(ary[0].dataPoints[22].ttip).toEqual('380716.55 at Tue Jan 01 2041');
      ...
      expect(ary[0].dataPoints[6].y).toEqual(75937.79038355971);
      expect(ary[0].dataPoints[6].ttip).toEqual('75937.79 at Sun Jan 01 2023');
      expect(ary[0].dataPoints[7].label).toEqual('Mon Jan 01 2024');
      expect(ary[0].dataPoints[7].y).toEqual(99914.40530690322);
      expect(ary[0].dataPoints[7].ttip).toEqual('99914.41 at Mon Jan 01 2024');
      expect(ary[0].dataPoints[8].label).toEqual('Wed Jan 01 2025');
      expect(ary[0].dataPoints[8].y).toEqual(124389.35282871363);
      expect(ary[0].dataPoints[8].ttip).toEqual('124389.35 at Wed Jan 01 2025');
      expect(ary[0].dataPoints[9].label).toEqual('Thu Jan 01 2026');
      expect(ary[0].dataPoints[9].y).toEqual(149373.12331346038);
      expect(ary[0].dataPoints[9].ttip).toEqual('149373.12 at Thu Jan 01 2026');
      expect(ary[0].dataPoints[10].label).toEqual('Fri Jan 01 2027');
      expect(ary[0].dataPoints[10].y).toEqual(174876.3535407145);
      expect(ary[0].dataPoints[10].ttip).toEqual('174876.35 at Fri Jan 01 2027');
      expect(ary[0].dataPoints[11].label).toEqual('Sat Jan 01 2028');
      expect(ary[0].dataPoints[11].y).toEqual(198127.24060376614);
      expect(ary[0].dataPoints[11].ttip).toEqual('198127.24 at Sat Jan 01 2028');
      expect(ary[0].dataPoints[12].label).toEqual('Mon Jan 01 2029');
      expect(ary[0].dataPoints[12].y).toEqual(199140.747207321);
      expect(ary[0].dataPoints[12].ttip).toEqual('199140.75 at Mon Jan 01 2029');
      expect(ary[0].dataPoints[13].label).toEqual('Tue Jan 01 2030');
      expect(ary[0].dataPoints[13].y).toEqual(199506.44553331943);
      expect(ary[0].dataPoints[13].ttip).toEqual('199506.45 at Tue Jan 01 2030');
      expect(ary[0].dataPoints[14].label).toEqual('Wed Jan 01 2031');
      expect(ary[0].dataPoints[14].y).toEqual(203942.2223986777);
      expect(ary[0].dataPoints[14].ttip).toEqual('203942.22 at Wed Jan 01 2031');
      expect(ary[0].dataPoints[15].label).toEqual('Thu Jan 01 2032');
      expect(ary[0].dataPoints[15].y).toEqual(208466.7148013432);
      expect(ary[0].dataPoints[15].ttip).toEqual('208466.71 at Thu Jan 01 2032');
      expect(ary[0].dataPoints[16].label).toEqual('Sat Jan 01 2033');
      expect(ary[0].dataPoints[16].y).toEqual(213081.697052062);
      expect(ary[0].dataPoints[16].ttip).toEqual('213081.70 at Sat Jan 01 2033');
      expect(ary[0].dataPoints[17].label).toEqual('Sun Jan 01 2034');
      expect(ary[0].dataPoints[17].y).toEqual(217788.9789477951);
      expect(ary[0].dataPoints[17].ttip).toEqual('217788.98 at Sun Jan 01 2034');
      expect(ary[0].dataPoints[18].label).toEqual('Mon Jan 01 2035');
      expect(ary[0].dataPoints[18].y).toEqual(222186.64597994564);
      expect(ary[0].dataPoints[18].ttip).toEqual('222186.65 at Mon Jan 01 2035');
      expect(ary[0].dataPoints[19].label).toEqual('Tue Jan 01 2036');
      expect(ary[0].dataPoints[19].y).toEqual(224631.33641709105);
      expect(ary[0].dataPoints[19].ttip).toEqual('224631.34 at Tue Jan 01 2036');
      expect(ary[0].dataPoints[20].label).toEqual('Thu Jan 01 2037');
      expect(ary[0].dataPoints[20].y).toEqual(227124.92066297942);
      expect(ary[0].dataPoints[20].ttip).toEqual('227124.92 at Thu Jan 01 2037');
      expect(ary[0].dataPoints[21].label).toEqual('Fri Jan 01 2038');
      expect(ary[0].dataPoints[21].y).toEqual(229668.3765937855);
      expect(ary[0].dataPoints[21].ttip).toEqual('229668.38 at Fri Jan 01 2038');
      expect(ary[0].dataPoints[22].label).toEqual('Sat Jan 01 2039');
      expect(ary[0].dataPoints[22].y).toEqual(232262.70164320772);
      expect(ary[0].dataPoints[22].ttip).toEqual('232262.70 at Sat Jan 01 2039');
      expect(ary[0].dataPoints[23].label).toEqual('Sun Jan 01 2040');
      expect(ary[0].dataPoints[23].y).toEqual(234686.38860167688);
      expect(ary[0].dataPoints[23].ttip).toEqual('234686.39 at Sun Jan 01 2040');
      expect(ary[0].dataPoints[24].label).toEqual('Tue Jan 01 2041');
      expect(ary[0].dataPoints[24].y).toEqual(234686.38860167688);
      expect(ary[0].dataPoints[24].ttip).toEqual('234686.39 at Tue Jan 01 2041');
      expect(ary[0].dataPoints[25].label).toEqual('Wed Jan 01 2042');
      expect(ary[0].dataPoints[25].y).toEqual(234686.38860167688);
      expect(ary[0].dataPoints[25].ttip).toEqual('234686.39 at Wed Jan 01 2042');
      expect(ary[0].dataPoints[26].label).toEqual('Thu Jan 01 2043');
      expect(ary[0].dataPoints[26].y).toEqual(234686.38860167688);
      expect(ary[0].dataPoints[26].ttip).toEqual('234686.39 at Thu Jan 01 2043');
      expect(ary[0].dataPoints[27].label).toEqual('Fri Jan 01 2044');
      expect(ary[0].dataPoints[27].y).toEqual(234686.38860167688);
      expect(ary[0].dataPoints[27].ttip).toEqual('234686.39 at Fri Jan 01 2044');
    } else if (
      ...
      expect(ary[0].dataPoints[4].label).toEqual('Sun Jan 01 2023');
      expect(ary[0].dataPoints[4].y).toEqual(50456.203333053956);
      expect(ary[0].dataPoints[4].ttip).toEqual('50456.20 at Sun Jan 01 2023');
      expect(ary[0].dataPoints[5].label).toEqual('Mon Jan 01 2024');
      expect(ary[0].dataPoints[5].y).toEqual(74432.81825639747);
      expect(ary[0].dataPoints[5].ttip).toEqual('74432.82 at Mon Jan 01 2024');
      expect(ary[0].dataPoints[6].label).toEqual('Wed Jan 01 2025');
      expect(ary[0].dataPoints[6].y).toEqual(98907.76577820787);
      expect(ary[0].dataPoints[6].ttip).toEqual('98907.77 at Wed Jan 01 2025');
      expect(ary[0].dataPoints[7].label).toEqual('Thu Jan 01 2026');
      expect(ary[0].dataPoints[7].y).toEqual(123891.53626295447);
      expect(ary[0].dataPoints[7].ttip).toEqual('123891.54 at Thu Jan 01 2026');
      expect(ary[0].dataPoints[8].label).toEqual('Fri Jan 01 2027');
      expect(ary[0].dataPoints[8].y).toEqual(149394.76649020857);
      expect(ary[0].dataPoints[8].ttip).toEqual('149394.77 at Fri Jan 01 2027');
      expect(ary[0].dataPoints[9].label).toEqual('Sat Jan 01 2028');
      expect(ary[0].dataPoints[9].y).toEqual(172645.6535532602);
      expect(ary[0].dataPoints[9].ttip).toEqual('172645.65 at Sat Jan 01 2028');
      expect(ary[0].dataPoints[10].label).toEqual('Mon Jan 01 2029');
      expect(ary[0].dataPoints[10].y).toEqual(173659.16015681505);
      expect(ary[0].dataPoints[10].ttip).toEqual('173659.16 at Mon Jan 01 2029');
      expect(ary[0].dataPoints[11].label).toEqual('Tue Jan 01 2030');
      expect(ary[0].dataPoints[11].y).toEqual(173659.16015681505);
      expect(ary[0].dataPoints[11].ttip).toEqual('173659.16 at Tue Jan 01 2030');
      expect(ary[0].dataPoints[12].label).toEqual('Wed Jan 01 2031');
      expect(ary[0].dataPoints[12].y).toEqual(188889.19637568903);
      expect(ary[0].dataPoints[12].ttip).toEqual('188889.20 at Wed Jan 01 2031');
      expect(ary[0].dataPoints[13].label).toEqual('Thu Jan 01 2032');
      expect(ary[0].dataPoints[13].y).toEqual(204499.98350003484);
      expect(ary[0].dataPoints[13].ttip).toEqual('204499.98 at Thu Jan 01 2032');
      expect(ary[0].dataPoints[14].label).toEqual('Sat Jan 01 2033');
      expect(ary[0].dataPoints[14].y).toEqual(220501.0403024893);
      expect(ary[0].dataPoints[14].ttip).toEqual('220501.04 at Sat Jan 01 2033');
      expect(ary[0].dataPoints[15].label).toEqual('Sun Jan 01 2034');
      expect(ary[0].dataPoints[15].y).toEqual(236902.12352500512);
      expect(ary[0].dataPoints[15].ttip).toEqual('236902.12 at Sun Jan 01 2034');
      expect(ary[0].dataPoints[16].label).toEqual('Mon Jan 01 2035');
      expect(ary[0].dataPoints[16].y).toEqual(253713.23382808384);
      expect(ary[0].dataPoints[16].ttip).toEqual('253713.23 at Mon Jan 01 2035');
      expect(ary[0].dataPoints[17].label).toEqual('Tue Jan 01 2036');
      expect(ary[0].dataPoints[17].y).toEqual(270944.6218887395);
      expect(ary[0].dataPoints[17].ttip).toEqual('270944.62 at Tue Jan 01 2036');
      expect(ary[0].dataPoints[18].label).toEqual('Thu Jan 01 2037');
      expect(ary[0].dataPoints[18].y).toEqual(288606.7946509116);
      expect(ary[0].dataPoints[18].ttip).toEqual('288606.79 at Thu Jan 01 2037');
      expect(ary[0].dataPoints[19].label).toEqual('Fri Jan 01 2038');
      expect(ary[0].dataPoints[19].y).toEqual(306710.52173213795);
      expect(ary[0].dataPoints[19].ttip).toEqual('306710.52 at Fri Jan 01 2038');
      expect(ary[0].dataPoints[20].label).toEqual('Sat Jan 01 2039');
      expect(ary[0].dataPoints[20].y).toEqual(318454.58066436887);
      expect(ary[0].dataPoints[20].ttip).toEqual('318454.58 at Sat Jan 01 2039');
      expect(ary[0].dataPoints[21].label).toEqual('Sun Jan 01 2040');
      expect(ary[0].dataPoints[21].y).toEqual(318454.58066436887);
      expect(ary[0].dataPoints[21].ttip).toEqual('318454.58 at Sun Jan 01 2040');
      expect(ary[0].dataPoints[22].label).toEqual('Tue Jan 01 2041');
      expect(ary[0].dataPoints[22].y).toEqual(318454.58066436887);
      expect(ary[0].dataPoints[22].ttip).toEqual('318454.58 at Tue Jan 01 2041');
      expect(ary[0].dataPoints[23].label).toEqual('Wed Jan 01 2042');
      expect(ary[0].dataPoints[23].y).toEqual(318454.58066436887);
      expect(ary[0].dataPoints[23].ttip).toEqual('318454.58 at Wed Jan 01 2042');
      expect(ary[0].dataPoints[24].label).toEqual('Thu Jan 01 2043');
      expect(ary[0].dataPoints[24].y).toEqual(318454.58066436887);
      expect(ary[0].dataPoints[24].ttip).toEqual('318454.58 at Thu Jan 01 2043');
      expect(ary[0].dataPoints[25].label).toEqual('Fri Jan 01 2044');
      expect(ary[0].dataPoints[25].y).toEqual(318454.58066436887);
      expect(ary[0].dataPoints[25].ttip).toEqual('318454.58 at Fri Jan 01 2044');
      expect(ary[0].dataPoints[26].label).toEqual('Sun Jan 01 2045');
      expect(ary[0].dataPoints[26].y).toEqual(318454.58066436887);
      expect(ary[0].dataPoints[26].ttip).toEqual('318454.58 at Sun Jan 01 2045');
      ...
      expect(ary[1].dataPoints[16].label).toEqual('Mon Jan 01 2035');
      expect(ary[1].dataPoints[16].y).toEqual(60334.78900039029);
      expect(ary[1].dataPoints[16].ttip).toEqual('60334.79 at Mon Jan 01 2035');
      expect(ary[1].dataPoints[17].label).toEqual('Tue Jan 01 2036');
      expect(ary[1].dataPoints[17].y).toEqual(45240.11854125839);
      expect(ary[1].dataPoints[17].ttip).toEqual('45240.12 at Tue Jan 01 2036');
      expect(ary[1].dataPoints[18].label).toEqual('Thu Jan 01 2037');
      expect(ary[1].dataPoints[18].y).toEqual(29020.944512361802);
      expect(ary[1].dataPoints[18].ttip).toEqual('29020.94 at Thu Jan 01 2037');
      expect(ary[1].dataPoints[19].label).toEqual('Fri Jan 01 2038');
      expect(ary[1].dataPoints[19].y).toEqual(11615.533168083526);
      expect(ary[1].dataPoints[19].ttip).toEqual('11615.53 at Fri Jan 01 2038');
      expect(ary[1].dataPoints[20].label).toEqual('Sat Jan 01 2039');
      ...
      expect(ary[2].dataPoints[12].label).toEqual('Wed Jan 01 2031');
      expect(ary[2].dataPoints[12].y).toEqual(110603.70479443143);
      expect(ary[2].dataPoints[12].ttip).toEqual('110603.70 at Wed Jan 01 2031');
      expect(ary[2].dataPoints[13].label).toEqual('Thu Jan 01 2032');
      expect(ary[2].dataPoints[13].y).toEqual(99446.12972974624);
      expect(ary[2].dataPoints[13].ttip).toEqual('99446.13 at Thu Jan 01 2032');
      expect(ary[2].dataPoints[14].label).toEqual('Sat Jan 01 2033');
      expect(ary[2].dataPoints[14].y).toEqual(87383.0952426394);
      expect(ary[2].dataPoints[14].ttip).toEqual('87383.10 at Sat Jan 01 2033');
      expect(ary[2].dataPoints[15].label).toEqual('Sun Jan 01 2034');
      expect(ary[2].dataPoints[15].y).toEqual(74363.77144548908);
      expect(ary[2].dataPoints[15].ttip).toEqual('74363.77 at Sun Jan 01 2034');
      expect(ary[2].dataPoints[16].label).toEqual('Mon Jan 01 2035');
      ...
      expect(ary[0].dataPoints[6].label).toEqual('Sun Jan 01 2023');
      expect(ary[0].dataPoints[6].y).toEqual(6441.372977996238);
      expect(ary[0].dataPoints[6].ttip).toEqual('6441.37 at Sun Jan 01 2023');
      expect(ary[0].dataPoints[7].label).toEqual('Mon Jan 01 2024');
      expect(ary[0].dataPoints[7].y).toEqual(7112.281127428558);
      expect(ary[0].dataPoints[7].ttip).toEqual('7112.28 at Mon Jan 01 2024');
      expect(ary[0].dataPoints[8].label).toEqual('Wed Jan 01 2025');
      expect(ary[0].dataPoints[8].y).toEqual(7102.172870856228);
      expect(ary[0].dataPoints[8].ttip).toEqual('7102.17 at Wed Jan 01 2025');
      expect(ary[0].dataPoints[9].label).toEqual('Thu Jan 01 2026');
      expect(ary[0].dataPoints[9].y).toEqual(6341.672139898609);
      expect(ary[0].dataPoints[9].ttip).toEqual('6341.67 at Thu Jan 01 2026');
      expect(ary[0].dataPoints[10].label).toEqual('Fri Jan 01 2027');
      expect(ary[0].dataPoints[10].y).toEqual(4755.789383848232);
      expect(ary[0].dataPoints[10].ttip).toEqual('4755.79 at Fri Jan 01 2027');
      expect(ary[0].dataPoints[11].label).toEqual('Sat Jan 01 2028');
      expect(ary[0].dataPoints[11].y).toEqual(2263.3861015663742);
      expect(ary[0].dataPoints[11].ttip).toEqual('2263.39 at Sat Jan 01 2028');
      expect(ary[0].dataPoints[12].label).toEqual('Mon Jan 01 2029');
      expect(ary[0].dataPoints[12].y).toEqual(-1223.2135919025102);
      expect(ary[0].dataPoints[12].ttip).toEqual('-1223.21 at Mon Jan 01 2029');
