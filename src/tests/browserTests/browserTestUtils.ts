...
function assertData(
  ...
  if (createButtonID === 'btn-create-Simple-example') {
    ...
    expect(ary.datasets[0].data[9]).toBeCloseTo(141829.66, 6);
    ...
    expect(ary.datasets[2].data[9]).toBeCloseTo(0, 6);
    expect(ary.datasets[2].data[10]).toBeCloseTo(0, 6);
    expect(ary.datasets[2].data[11]).toBeCloseTo(23217.64, 6);
    expect(ary.datasets[2].data[12]).toBeCloseTo(24262.43, 6);
    expect(ary.datasets[2].data[13]).toBeCloseTo(25354.24, 6);
    expect(ary.datasets[2].data[14]).toBeCloseTo(26495.18, 6);
    expect(ary.datasets[2].data[15]).toBeCloseTo(27687.46, 6);
    expect(ary.datasets[2].data[16]).toBeCloseTo(28933.4, 6);
    expect(ary.datasets[2].data[17]).toBeCloseTo(30235.4, 6);
    expect(ary.datasets[2].data[18]).toBeCloseTo(31595.99, 6);
    expect(ary.datasets[2].data[19]).toBeCloseTo(33017.81, 6);
    expect(ary.datasets[2].data[20]).toBeCloseTo(34503.61, 6);
    expect(ary.datasets[2].data[21]).toBeCloseTo(36056.28, 6);
    expect(ary.datasets[2].data[22]).toBeCloseTo(37678.81, 6);
    expect(ary.datasets[2].data[23]).toBeCloseTo(39374.36, 6);
    ...
    expect(ary.datasets[3].data[2]).toBeCloseTo(1400.7, 6);
    expect(ary.datasets[3].data[3]).toBeCloseTo(18528.7, 6);
    expect(ary.datasets[3].data[4]).toBeCloseTo(36427.47, 6);
    expect(ary.datasets[3].data[5]).toBeCloseTo(55131.67, 6);
    expect(ary.datasets[3].data[6]).toBeCloseTo(74677.57, 6);
    expect(ary.datasets[3].data[7]).toBeCloseTo(77877.65, 6);
    expect(ary.datasets[3].data[8]).toBeCloseTo(81382.14, 6);
    expect(ary.datasets[3].data[9]).toBeCloseTo(85044.34, 6);
    expect(ary.datasets[3].data[10]).toBeCloseTo(88871.33, 6);
    expect(ary.datasets[3].data[11]).toBeCloseTo(0, 6);
    expect(ary.datasets[3].data[12]).toBeCloseTo(0, 6);
    expect(ary.datasets[3].data[13]).toBeCloseTo(0, 6);
    expect(ary.datasets[3].data[14]).toBeCloseTo(0, 6);
    expect(ary.datasets[3].data[15]).toBeCloseTo(0, 6);
    expect(ary.datasets[3].data[16]).toBeCloseTo(0, 6);
    expect(ary.datasets[3].data[17]).toBeCloseTo(0, 6);
    expect(ary.datasets[3].data[18]).toBeCloseTo(0, 6);
    expect(ary.datasets[3].data[19]).toBeCloseTo(0, 6);
    expect(ary.datasets[3].data[20]).toBeCloseTo(0, 6);
    expect(ary.datasets[3].data[21]).toBeCloseTo(0, 6);
    expect(ary.datasets[3].data[22]).toBeCloseTo(0, 6);
    expect(ary.datasets[3].data[23]).toBeCloseTo(0, 6);
    ...
    expect(ary.datasets[0].data[9]).toBeCloseTo(17824.87, 6);
    expect(ary.datasets[0].data[10]).toBeCloseTo(20744.51, 6);
    expect(ary.datasets[0].data[11]).toBeCloseTo(23644.7, 6);
    expect(ary.datasets[0].data[12]).toBeCloseTo(26524.87, 6);
