...
*/
  ...
  it('special case bond maturity transactions', done => {
    ...
    expect(evals.length).toBe(24);
    expectEvals(evals, 0, 'BMVBondTargetValue/Thu Apr 12 2018 00:00:00 GMT+0100 (British Summer Time)/cpi', 'Fri Dec 01 2017', 1.02, 2);
    expectEvals(evals, 1, 'BMVBondTargetValue/Sat May 12 2018 00:00:00 GMT+0100 (British Summer Time)/cpi', 'Fri Dec 01 2017', 1.03, 2);
    expectEvals(evals, 2, 'BMVBondTargetValue/Tue Jun 12 2018 00:00:00 GMT+0100 (British Summer Time)/cpi', 'Fri Dec 01 2017', 1.04, 2);
    expectEvals(evals, 3, 'BMVBondTargetValue/Thu Jul 12 2018 00:00:00 GMT+0100 (British Summer Time)/cpi', 'Fri Dec 01 2017', 1.05, 2);
  ...
  it('special case bond investment transactions got enough cash', done => {
    ...
    expect(evals.length).toBe(43);
    expectEvals(evals, 0, 'BMVBondTargetValue/Fri Apr 12 2019 00:00:00 GMT+0100 (British Summer Time)/cpi', 'Fri Dec 01 2017', 1.14, 2);
  ...
  it('special case bond investment transactions zero cpi', done => {
    ...
    expect(evals.length).toBe(43);
    expectEvals(evals, 0, 'BMVBondTargetValue/Fri Apr 12 2019 00:00:00 GMT+0100 (British Summer Time)/cpi', 'Fri Dec 01 2017', 1, -1);
    expectEvals(evals, 1, 'BondTargetValue', 'Fri Apr 12 2019', 1, -1);
    expectEvals(evals, 2, 'Cash', 'Mon Jan 01 2018', 1000, -1);
    expectEvals(evals, 3, 'Bond', 'Mon Jan 01 2018', 1000, -1);
    expectEvals(evals, 4, 'Cash', 'Thu Feb 01 2018', 1000, -1);
  ...
  it('special case bond investment transactions repeat overlap', done => {
    ...
    expectEvals(evals, 0, 'BMVBondTargetValue/Fri Apr 12 2019 00:00:00 GMT+0100 (British Summer Time)/cpi', 'Fri Dec 01 2017', 1, -1);
    expectEvals(evals, 1, 'BMVBondTargetValue/Sun May 12 2019 00:00:00 GMT+0100 (British Summer Time)/cpi', 'Fri Dec 01 2017', 1, -1);
  ...
  it('special case bond investment transactions repeat disjoint', done => {
    ...
    expect(evals.length).toBe(94);
    expectEvals(evals, 0, 'BMVBondTargetValue/Fri Apr 12 2019 00:00:00 GMT+0100 (British Summer Time)/cpi', 'Fri Dec 01 2017', 1, -1);
    expectEvals(evals, 1, 'BMVBondTargetValue/Mon Apr 12 2021 00:00:00 GMT+0100 (British Summer Time)/cpi', 'Fri Dec 01 2017', 1, -1);
    expectEvals(evals, 2, 'BondTargetValue', 'Fri Apr 12 2019', 1, -1);
    expectEvals(evals, 3, 'Cash', 'Mon Jan 01 2018', 1000, -1);
    expectEvals(evals, 4, 'Bond', 'Mon Jan 01 2018', 1000, -1);
    expectEvals(evals, 5, 'Cash', 'Thu Feb 01 2018', 1000, -1);
