...
*/
  ...
  it('taxBands grow with cpi', done => {
    ...
    expectEvals(evals, 55, 'Cash', 'Sun Sep 01 2019', 18227.5, 2);
    expectEvals(evals, 56, 'PRnd', 'Sun Sep 01 2019', 1042.5, 2);
    expectEvals(evals, 57, 'Cash', 'Sun Sep 01 2019', 19270.0, 2);
    expectEvals(evals, 58, 'Cash', 'Tue Oct 01 2019', 19270.8, 2);
    expectEvals(evals, 59, 'PRnd', 'Tue Oct 01 2019', 1042.5, 2);
    expectEvals(evals, 60, 'Cash', 'Tue Oct 01 2019', 20313.3, 2);
    ...
    expectEvals(evals, 79, 'Cash', 'Sun Apr 05 2020', 26573.28, 2);
    expectEvals(evals, 80, '(incomeTax)', 'Sun Apr 05 2020', 0.75, 2);
    expectEvals(evals, 81, 'Joe income (net)', 'Sun Apr 05 2020', 12509.25, 2);
    expectEvals(evals, 82, 'Cash', 'Fri May 01 2020', 26574.39, 2);
    expectEvals(evals, 83, 'PRnd', 'Fri May 01 2020', 1042.5, 2);
    expectEvals(evals, 84, 'Cash', 'Fri May 01 2020', 27616.89, 2);
    expectEvals(evals, 85, 'Cash', 'Mon Jun 01 2020', 27618.04, 2);
    expectEvals(evals, 86, 'PRnd', 'Mon Jun 01 2020', 1042.5, 2);
    expectEvals(evals, 87, 'Cash', 'Mon Jun 01 2020', 28660.54, 2);
    expectEvals(evals, 88, 'Cash', 'Wed Jul 01 2020', 28661.73, 2);
    expectEvals(evals, 89, 'PRnd', 'Wed Jul 01 2020', 1042.5, 2);
    expectEvals(evals, 90, 'Cash', 'Wed Jul 01 2020', 29704.23, 2);
    expectEvals(evals, 91, 'Cash', 'Sat Aug 01 2020', 29705.47, 2);
    expectEvals(evals, 92, 'PRnd', 'Sat Aug 01 2020', 1042.5, 2);
    expectEvals(evals, 93, 'Cash', 'Sat Aug 01 2020', 30747.97, 2);
    expectEvals(evals, 94, 'Cash', 'Tue Sep 01 2020', 30749.25, 2);
    expectEvals(evals, 95, 'PRnd', 'Tue Sep 01 2020', 1042.5, 2);
    expectEvals(evals, 96, 'Cash', 'Tue Sep 01 2020', 31791.75, 2);
    expectEvals(evals, 97, 'Cash', 'Thu Oct 01 2020', 31793.08, 2);
    expectEvals(evals, 98, 'PRnd', 'Thu Oct 01 2020', 1042.5, 2);
    expectEvals(evals, 99, 'Cash', 'Thu Oct 01 2020', 32835.58, 2);
    expectEvals(evals, 100, 'Cash', 'Sun Nov 01 2020', 32836.94, 2);
    expectEvals(evals, 101, 'PRnd', 'Sun Nov 01 2020', 1042.5, 2);
    expectEvals(evals, 102, 'Cash', 'Sun Nov 01 2020', 33879.44, 2);
    expectEvals(evals, 103, 'Cash', 'Tue Dec 01 2020', 33880.85, 2);
    expectEvals(evals, 104, 'PRnd', 'Tue Dec 01 2020', 1042.5, 2);
    expectEvals(evals, 105, 'Cash', 'Tue Dec 01 2020', 34923.35, 2);
    expectEvals(evals, 106, 'Cash', 'Fri Jan 01 2021', 34924.81, 2);
    expectEvals(evals, 107, 'PRnd', 'Fri Jan 01 2021', 1042.5, 2);
    expectEvals(evals, 108, 'Cash', 'Fri Jan 01 2021', 35967.31, 2);
    expectEvals(evals, 109, 'Cash', 'Mon Feb 01 2021', 35968.81, 2);
    expectEvals(evals, 110, 'PRnd', 'Mon Feb 01 2021', 1042.5, 2);
    expectEvals(evals, 111, 'Cash', 'Mon Feb 01 2021', 37011.31, 2);
    expectEvals(evals, 112, 'Cash', 'Mon Mar 01 2021', 37012.85, 2);
    expectEvals(evals, 113, 'PRnd', 'Mon Mar 01 2021', 1042.5, 2);
    expectEvals(evals, 114, 'Cash', 'Mon Mar 01 2021', 38055.35, 2);
    expectEvals(evals, 115, 'Cash', 'Thu Apr 01 2021', 38056.93, 2);
    expectEvals(evals, 116, 'PRnd', 'Thu Apr 01 2021', 1042.5, 2);
    expectEvals(evals, 117, 'Cash', 'Thu Apr 01 2021', 39099.43, 2);
    expectEvals(
      evals,
      118,
      getnetincLabel('Joe'),
  ...
  it('revalue a setting 01', done => {
    ...
    expect(result.assetData[0].item.NAME).toBe('Cash');
    {
      ...
      expectChartData(chartPts, 2, 'Fri Jan 01 2021', 20938.2, 2);
      expectChartData(chartPts, 3, 'Sat Jan 01 2022', 26930.48, 2);
      expectChartData(chartPts, 4, 'Sun Jan 01 2023', 33474.7, 2);
      expectChartData(chartPts, 5, 'Mon Jan 01 2024', 40567.27, 2);
      expectChartData(chartPts, 6, 'Wed Jan 01 2025', 48201.63, 2);
      expectChartData(chartPts, 7, 'Thu Jan 01 2026', 58596.02, 2);
      expectChartData(chartPts, 8, 'Fri Jan 01 2027', 82812.49, 2);
      expectChartData(chartPts, 9, 'Sat Jan 01 2028', 110481.01, 2);
      expectChartData(chartPts, 10, 'Mon Jan 01 2029', 138585.14, 2);
      expectChartData(chartPts, 11, 'Tue Jan 01 2030', 150591.06, 2);
      expectChartData(chartPts, 12, 'Wed Jan 01 2031', 157585.81, 2);
      expectChartData(chartPts, 13, 'Thu Jan 01 2032', 165495.33, 2);
      expectChartData(chartPts, 14, 'Sat Jan 01 2033', 174367.42, 2);
      expectChartData(chartPts, 15, 'Sun Jan 01 2034', 187302.82, 2);
      expectChartData(chartPts, 16, 'Mon Jan 01 2035', 216533.61, 2);
      expectChartData(chartPts, 17, 'Tue Jan 01 2036', 247340.45, 2);
      expectChartData(chartPts, 18, 'Thu Jan 01 2037', 279791.56, 2);
      expectChartData(chartPts, 19, 'Fri Jan 01 2038', 313957.94, 2);
      expectChartData(chartPts, 20, 'Sat Jan 01 2039', 349913.45, 2);
      expectChartData(chartPts, 21, 'Sun Jan 01 2040', 387734.97, 2);
      expectChartData(chartPts, 22, 'Tue Jan 01 2041', 427502.49, 2);
    }
    ...
    expect(result.taxData[0].item.NAME).toBe('Joe income (net)');
    {
      ...
      expectChartData(chartPts, 2, 'Fri Jan 01 2021', 38656.75, 2);
      expectChartData(chartPts, 3, 'Sat Jan 01 2022', 40345.06, 2);
      expectChartData(chartPts, 4, 'Sun Jan 01 2023', 42108.05, 2);
      expectChartData(chartPts, 5, 'Mon Jan 01 2024', 43949.07, 2);
      expectChartData(chartPts, 6, 'Wed Jan 01 2025', 45871.59, 2);
      expectChartData(chartPts, 7, 'Thu Jan 01 2026', 47879.24, 2);
      expectChartData(chartPts, 8, 'Fri Jan 01 2027', 49975.82, 2);
      expectChartData(chartPts, 9, 'Sat Jan 01 2028', 52069.51, 2);
      expectChartData(chartPts, 10, 'Mon Jan 01 2029', 54108.03, 2);
      expectChartData(chartPts, 11, 'Tue Jan 01 2030', 56230.68, 2);
      expectChartData(chartPts, 12, 'Wed Jan 01 2031', 58441.04, 2);
      expectChartData(chartPts, 13, 'Thu Jan 01 2032', 60742.86, 2);
      expectChartData(chartPts, 14, 'Sat Jan 01 2033', 63140.07, 2);
      expectChartData(chartPts, 15, 'Sun Jan 01 2034', 65636.74, 2);
      expectChartData(chartPts, 16, 'Mon Jan 01 2035', 68237.15, 2);
      expectChartData(chartPts, 17, 'Tue Jan 01 2036', 70945.75, 2);
      expectChartData(chartPts, 18, 'Thu Jan 01 2037', 73767.18, 2);
      expectChartData(chartPts, 19, 'Fri Jan 01 2038', 76706.3, 2);
      expectChartData(chartPts, 20, 'Sat Jan 01 2039', 79768.17, 2);
      expectChartData(chartPts, 21, 'Sun Jan 01 2040', 82958.08, 2);
      expectChartData(chartPts, 22, 'Tue Jan 01 2041', 86281.54, 2);
    }
    ...
    expect(result.taxData[1].item.NAME).toBe('Joe income (incomeTax)');
    {
      ...
      expectChartData(chartPts, 2, 'Fri Jan 01 2021', 6461.06, 2);
      expectChartData(chartPts, 3, 'Sat Jan 01 2022', 6803.06, 2);
      expectChartData(chartPts, 4, 'Sun Jan 01 2023', 7161.73, 2);
      expectChartData(chartPts, 5, 'Mon Jan 01 2024', 7537.85, 2);
      expectChartData(chartPts, 6, 'Wed Jan 01 2025', 7932.25, 2);
      expectChartData(chartPts, 7, 'Thu Jan 01 2026', 8345.77, 2);
      expectChartData(chartPts, 8, 'Fri Jan 01 2027', 8779.31, 2);
      expectChartData(chartPts, 9, 'Sat Jan 01 2028', 9329.61, 2);
      expectChartData(chartPts, 10, 'Mon Jan 01 2029', 10054.04, 2);
      expectChartData(chartPts, 11, 'Tue Jan 01 2030', 10818.69, 2);
      expectChartData(chartPts, 12, 'Wed Jan 01 2031', 11625.55, 2);
      expectChartData(chartPts, 13, 'Thu Jan 01 2032', 12476.72, 2);
      expectChartData(chartPts, 14, 'Sat Jan 01 2033', 13374.4, 2);
      expectChartData(chartPts, 15, 'Sun Jan 01 2034', 14320.87, 2);
      expectChartData(chartPts, 16, 'Mon Jan 01 2035', 15318.56, 2);
      expectChartData(chartPts, 17, 'Tue Jan 01 2036', 16369.97, 2);
      expectChartData(chartPts, 18, 'Thu Jan 01 2037', 17477.74, 2);
      expectChartData(chartPts, 19, 'Fri Jan 01 2038', 18644.65, 2);
      expectChartData(chartPts, 20, 'Sat Jan 01 2039', 19873.57, 2);
      expectChartData(chartPts, 21, 'Sun Jan 01 2040', 21167.54, 2);
      expectChartData(chartPts, 22, 'Tue Jan 01 2041', 22529.74, 2);
    }
  ...
  it('Generate taxable income from asset', done => {
    ...
    expectEvals(evals, 68, 'Joe income (net)', 'Fri Apr 05 2019', 14794.06, 2);
  ...
  it('Defined Benefits Pension evaluations', done => {
    ...
    const PDBTPS = 'PensionDBTeachersPensionScheme';
    ...
    expectEvals(evals, 12, PDBTPS, 'Sun Dec 01 2019', 0, -1);
    expectEvals(evals, 13, 'Cash', 'Wed Jan 01 2020', 0, -1);
    expectEvals(evals, 14, PDBTPS, 'Wed Jan 01 2020', 0, -1);
    ...
    expectEvals(evals, 18, PDBTPS, 'Sat Feb 01 2020', 0, -1);
    ...
    expectEvals(evals, 22, PDBTPS, 'Sun Mar 01 2020', 0, -1);
    ...
    expectEvals(evals, 26, PDBTPS, 'Wed Apr 01 2020', 0, -1);
    expectEvals(evals, 27, 'TeachingJob', 'Wed Apr 01 2020', 2512.41, 2);
    expectEvals(evals, 28, 'Cash', 'Wed Apr 01 2020', 10024.8, 2);
    expectEvals(evals, 29, 'Joe income (net)', 'Sun Apr 05 2020', 10024.8, 2);
    expectEvals(evals, 30, 'Cash', 'Sun Apr 05 2020', 9883.07, 2);
    expectEvals(evals, 31, '(NI)', 'Sun Apr 05 2020', 141.73, 2);
    expectEvals(evals, 32, 'Joe income (net)', 'Sun Apr 05 2020', 9883.07, 2);
    expectEvals(evals, 33, 'Cash', 'Fri May 01 2020', 9883.07, 2);
    expectEvals(evals, 34, PDBTPS, 'Fri May 01 2020', 0, -1);
    expectEvals(evals, 35, 'TeachingJob', 'Fri May 01 2020', 2516.56, 2);
    expectEvals(evals, 36, 'Cash', 'Fri May 01 2020', 12399.63, 2);
    expectEvals(evals, 37, 'Cash', 'Mon Jun 01 2020', 12399.63, 2);
    expectEvals(evals, 38, PDBTPS, 'Mon Jun 01 2020', 0, -1);
    expectEvals(evals, 39, 'TeachingJob', 'Mon Jun 01 2020', 2520.71, 2);
    expectEvals(evals, 40, 'Cash', 'Mon Jun 01 2020', 14920.34, 2);
    expectEvals(evals, 41, 'Cash', 'Wed Jul 01 2020', 14920.34, 2);
    expectEvals(evals, 42, PDBTPS, 'Wed Jul 01 2020', 0, -1);
    expectEvals(evals, 43, 'TeachingJob', 'Wed Jul 01 2020', 2524.88, 2);
    expectEvals(evals, 44, 'Cash', 'Wed Jul 01 2020', 17445.21, 2);
    expectEvals(evals, 45, 'Cash', 'Sat Aug 01 2020', 17445.21, 2);
    expectEvals(evals, 46, PDBTPS, 'Sat Aug 01 2020', 0, -1);
    expectEvals(evals, 47, 'TeachingJob', 'Sat Aug 01 2020', 2529.05, 2);
    expectEvals(evals, 48, 'Cash', 'Sat Aug 01 2020', 19974.26, 2);
    expectEvals(evals, 49, 'Cash', 'Tue Sep 01 2020', 19974.26, 2);
    expectEvals(evals, 50, PDBTPS, 'Tue Sep 01 2020', 0, -1);
    expectEvals(evals, 51, 'TeachingJob', 'Tue Sep 01 2020', 2533.22, 2);
    expectEvals(evals, 52, 'Cash', 'Tue Sep 01 2020', 22507.48, 2);
    expectEvals(evals, 53, 'Cash', 'Thu Oct 01 2020', 22507.48, 2);
    expectEvals(evals, 54, PDBTPS, 'Thu Oct 01 2020', 0, -1);
    expectEvals(evals, 55, 'TeachingJob', 'Thu Oct 01 2020', 2537.41, 2);
    expectEvals(evals, 56, 'Cash', 'Thu Oct 01 2020', 25044.89, 2);
    expectEvals(evals, 57, 'Cash', 'Sun Nov 01 2020', 25044.89, 2);
    expectEvals(evals, 58, PDBTPS, 'Sun Nov 01 2020', 0, -1);
    expectEvals(evals, 59, 'TeachingJob', 'Sun Nov 01 2020', 2541.6, 2);
    expectEvals(evals, 60, 'Cash', 'Sun Nov 01 2020', 27586.49, 2);
    expectEvals(evals, 61, 'Cash', 'Tue Dec 01 2020', 27586.49, 2);
    expectEvals(evals, 62, PDBTPS, 'Tue Dec 01 2020', 0, -1);
    expectEvals(evals, 63, 'TeachingJob', 'Tue Dec 01 2020', 2545.8, 2);
    expectEvals(evals, 64, 'Cash', 'Tue Dec 01 2020', 30132.28, 2);
    expectEvals(evals, 65, 'Cash', 'Fri Jan 01 2021', 30132.28, 2);
    expectEvals(evals, 66, PDBTPS, 'Fri Jan 01 2021', 0, -1);
    expectEvals(evals, 67, 'TeachingJob', 'Fri Jan 01 2021', 2550.0, 2);
    expectEvals(evals, 68, 'Cash', 'Fri Jan 01 2021', 32682.28, 2);
    expectEvals(evals, 69, 'Cash', 'Mon Feb 01 2021', 32682.28, 2);
    expectEvals(evals, 70, PDBTPS, 'Mon Feb 01 2021', 0, -1);
    expectEvals(evals, 71, 'TeachingJob', 'Mon Feb 01 2021', 2554.21, 2);
    expectEvals(evals, 72, 'Cash', 'Mon Feb 01 2021', 35236.5, 2);
    expectEvals(evals, 73, 'Cash', 'Mon Mar 01 2021', 35236.5, 2);
    expectEvals(evals, 74, PDBTPS, 'Mon Mar 01 2021', 0, -1);
    expectEvals(evals, 75, 'TeachingJob', 'Mon Mar 01 2021', 2558.43, 2);
    expectEvals(evals, 76, 'Cash', 'Mon Mar 01 2021', 37794.93, 2);
    expectEvals(evals, 77, 'Cash', 'Thu Apr 01 2021', 37794.93, 2);
    expectEvals(evals, 78, PDBTPS, 'Thu Apr 01 2021', 0, -1);
    expectEvals(evals, 79, 'TeachingJob', 'Thu Apr 01 2021', 2562.66, 2);
    expectEvals(evals, 80, 'Cash', 'Thu Apr 01 2021', 40357.58, 2);
    expectEvals(evals, 81, 'Cash', 'Mon Apr 05 2021', 36889.24, 2);
    expectEvals(evals, 82, '(incomeTax)', 'Mon Apr 05 2021', 3468.34, 2);
    expectEvals(evals, 83, 'Joe income (net)', 'Mon Apr 05 2021', 27006.17, 2);
    expectEvals(evals, 84, 'Cash', 'Mon Apr 05 2021', 34320.08, 2);
    expectEvals(evals, 85, '(NI)', 'Mon Apr 05 2021', 2569.17, 2);
    expectEvals(evals, 86, 'Joe income (net)', 'Mon Apr 05 2021', 24437.01, 2);
    expectEvals(evals, 87, 'Cash', 'Sat May 01 2021', 34320.08, 2);
    expectEvals(evals, 88, PDBTPS, 'Sat May 01 2021', 0, -1);
    expectEvals(evals, 89, 'TeachingJob', 'Sat May 01 2021', 2566.89, 2);
    expectEvals(evals, 90, 'Cash', 'Sat May 01 2021', 36886.96, 2);
    expectEvals(evals, 91, 'Joe income (net)', 'Tue Apr 05 2022', 2566.89, 2);
    expectEvals(evals, 92, 'Joe income (net)', 'Tue Apr 05 2022', 2566.89, 2);
    ...
    expect(result.assetData[0].item.NAME).toBe('Cash');
    {
      ...
      expectChartData(chartPts, 4, 'Wed Apr 01 2020', 10024.8, 2);
      expectChartData(chartPts, 5, 'Fri May 01 2020', 12399.63, 2);
      expectChartData(chartPts, 6, 'Mon Jun 01 2020', 14920.34, 2);
      expectChartData(chartPts, 7, 'Wed Jul 01 2020', 17445.21, 2);
      expectChartData(chartPts, 8, 'Sat Aug 01 2020', 19974.26, 2);
      expectChartData(chartPts, 9, 'Tue Sep 01 2020', 22507.48, 2);
      expectChartData(chartPts, 10, 'Thu Oct 01 2020', 25044.89, 2);
      expectChartData(chartPts, 11, 'Sun Nov 01 2020', 27586.49, 2);
      expectChartData(chartPts, 12, 'Tue Dec 01 2020', 30132.28, 2);
      expectChartData(chartPts, 13, 'Fri Jan 01 2021', 32682.28, 2);
      expectChartData(chartPts, 14, 'Mon Feb 01 2021', 35236.5, 2);
      expectChartData(chartPts, 15, 'Mon Mar 01 2021', 37794.93, 2);
      expectChartData(chartPts, 16, 'Thu Apr 01 2021', 40357.58, 2);
      expectChartData(chartPts, 17, 'Sat May 01 2021', 36886.96, 2);
    }
    ...
    expect(result.taxData[0].item.NAME).toBe('Joe income (net)');
    {
      ...
      expectChartData(chartPts, 5, 'Fri May 01 2020', 9883.07, 2);
      ...
      expectChartData(chartPts, 17, 'Sat May 01 2021', 24437.01, 2);
    }
    ...
    expect(result.taxData[1].item.NAME).toBe('Joe income (NI)');
    {
      ...
      expectChartData(chartPts, 3, 'Sun Mar 01 2020', 0, -1);
      expectChartData(chartPts, 4, 'Wed Apr 01 2020', 0, -1);
      expectChartData(chartPts, 5, 'Fri May 01 2020', 141.73, 2);
      expectChartData(chartPts, 6, 'Mon Jun 01 2020', 0, -1);
      expectChartData(chartPts, 7, 'Wed Jul 01 2020', 0, -1);
      expectChartData(chartPts, 8, 'Sat Aug 01 2020', 0, -1);
      expectChartData(chartPts, 9, 'Tue Sep 01 2020', 0, -1);
      ...
      expectChartData(chartPts, 15, 'Mon Mar 01 2021', 0, -1);
      expectChartData(chartPts, 16, 'Thu Apr 01 2021', 0, -1);
      expectChartData(chartPts, 17, 'Sat May 01 2021', 2569.17, 2);
    }
    ...
    expect(result.taxData[2].item.NAME).toBe('Joe income (incomeTax)');
    {
      ...
      expectChartData(chartPts, 15, 'Mon Mar 01 2021', 0, -1);
      expectChartData(chartPts, 16, 'Thu Apr 01 2021', 0, -1);
      expectChartData(chartPts, 17, 'Sat May 01 2021', 3468.34, 2);
    }
