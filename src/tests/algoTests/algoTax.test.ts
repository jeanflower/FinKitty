...
describe('tax tests', () => {
  ...
  it('taxBands grow with cpi', (done) => {
    ...
    expect(result.assetData[0].item.NAME).toBe('Cash');
    {
      ...
      expectChartData(chartPts, 25, 'Sun May 01 2022', 27615.88, 2);
      expectChartData(chartPts, 26, 'Wed Jun 01 2022', 28659.53, 2);
      expectChartData(chartPts, 27, 'Fri Jul 01 2022', 29703.22, 2);
      expectChartData(chartPts, 28, 'Mon Aug 01 2022', 30746.96, 2);
      expectChartData(chartPts, 29, 'Thu Sep 01 2022', 31790.74, 2);
      expectChartData(chartPts, 30, 'Sat Oct 01 2022', 32834.56, 2);
      expectChartData(chartPts, 31, 'Tue Nov 01 2022', 33878.43, 2);
      expectChartData(chartPts, 32, 'Thu Dec 01 2022', 34922.34, 2);
      expectChartData(chartPts, 33, 'Sun Jan 01 2023', 35966.3, 2);
      expectChartData(chartPts, 34, 'Wed Feb 01 2023', 37010.3, 2);
      expectChartData(chartPts, 35, 'Wed Mar 01 2023', 38054.34, 2);
      expectChartData(chartPts, 36, 'Sat Apr 01 2023', 39098.42, 2);
      expectChartData(chartPts, 37, 'Mon May 01 2023', 40142.55, 2);
      expectChartData(chartPts, 38, 'Thu Jun 01 2023', 41186.72, 2);
      expectChartData(chartPts, 39, 'Sat Jul 01 2023', 42230.94, 2);
      expectChartData(chartPts, 40, 'Tue Aug 01 2023', 43275.2, 2);
      expectChartData(chartPts, 41, 'Fri Sep 01 2023', 44319.5, 2);
      expectChartData(chartPts, 42, 'Sun Oct 01 2023', 45363.85, 2);
      expectChartData(chartPts, 43, 'Wed Nov 01 2023', 46408.24, 2);
      expectChartData(chartPts, 44, 'Fri Dec 01 2023', 47452.67, 2);
      expectChartData(chartPts, 45, 'Mon Jan 01 2024', 48497.15, 2);
      expectChartData(chartPts, 46, 'Thu Feb 01 2024', 49541.67, 2);
      expectChartData(chartPts, 47, 'Fri Mar 01 2024', 50586.23, 2);
      expectChartData(chartPts, 48, 'Mon Apr 01 2024', 51630.84, 2);
      expectChartData(chartPts, 49, 'Wed May 01 2024', 52675.49, 2);
      expectChartData(chartPts, 50, 'Sat Jun 01 2024', 53720.18, 2);
      expectChartData(chartPts, 51, 'Mon Jul 01 2024', 54764.92, 2);
      expectChartData(chartPts, 52, 'Thu Aug 01 2024', 55809.7, 2);
      expectChartData(chartPts, 53, 'Sun Sep 01 2024', 56854.53, 2);
      expectChartData(chartPts, 54, 'Tue Oct 01 2024', 57899.4, 2);
      expectChartData(chartPts, 55, 'Fri Nov 01 2024', 58944.31, 2);
      expectChartData(chartPts, 56, 'Sun Dec 01 2024', 59989.26, 2);
      expectChartData(chartPts, 57, 'Wed Jan 01 2025', 61034.26, 2);
      expectChartData(chartPts, 58, 'Sat Feb 01 2025', 62079.31, 2);
      expectChartData(chartPts, 59, 'Sat Mar 01 2025', 63124.39, 2);
      expectChartData(chartPts, 60, 'Tue Apr 01 2025', 64169.52, 2);
      expectChartData(chartPts, 61, 'Thu May 01 2025', 65214.69, 2);
      expectChartData(chartPts, 62, 'Sun Jun 01 2025', 66259.91, 2);
      expectChartData(chartPts, 63, 'Tue Jul 01 2025', 67305.17, 2);
      expectChartData(chartPts, 64, 'Fri Aug 01 2025', 68350.48, 2);
      expectChartData(chartPts, 65, 'Mon Sep 01 2025', 69395.82, 2);
      expectChartData(chartPts, 66, 'Wed Oct 01 2025', 70441.21, 2);
      expectChartData(chartPts, 67, 'Sat Nov 01 2025', 71486.65, 2);
      expectChartData(chartPts, 68, 'Mon Dec 01 2025', 72532.13, 2);
      expectChartData(chartPts, 69, 'Thu Jan 01 2026', 73577.65, 2);
      expectChartData(chartPts, 70, 'Sun Feb 01 2026', 74623.21, 2);
      expectChartData(chartPts, 71, 'Sun Mar 01 2026', 75668.82, 2);
      expectChartData(chartPts, 72, 'Wed Apr 01 2026', 76714.47, 2);
    }
    ...
    expect(result.taxData[0].item.NAME).toBe('Joe income (net)');
    {
      ...
      expectChartData(chartPts, 25, 'Sun May 01 2022', 12510, -1);
    ...
    expect(result.taxData[1].item.NAME).toBe('Joe income (incomeTax)');
    {
      ...
      expectChartData(chartPts, 23, 'Tue Mar 01 2022', 0, -1);
      expectChartData(chartPts, 24, 'Fri Apr 01 2022', 0, -1);
      expectChartData(chartPts, 25, 'Sun May 01 2022', 0, -1);
      expectChartData(chartPts, 26, 'Wed Jun 01 2022', 0, -1);
      expectChartData(chartPts, 27, 'Fri Jul 01 2022', 0, -1);
      expectChartData(chartPts, 28, 'Mon Aug 01 2022', 0, -1);
      expectChartData(chartPts, 29, 'Thu Sep 01 2022', 0, -1);
