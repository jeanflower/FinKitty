...
function getBenAndJerryModel(): ModelData {
  const model: ModelData = {
    ...
    transactions: [
      ...
      {
        NAME: `ConditionalSell Prudential${taxFree}`,
        CATEGORY: 'Cashflow',
        FROM: `Ben Prudential${taxFree}`,
        FROM_ABSOLUTE: true,
        FROM_VALUE: '250',
        TO: 'Cash',
        TO_ABSOLUTE: false,
      ...
      {
        NAME: `ConditionalSell Aegon${taxFree}`,
        CATEGORY: 'Cashflow',
        FROM: `Jerry Aegon${taxFree}`,
        FROM_ABSOLUTE: true,
        FROM_VALUE: '250',
        TO: 'Cash',
        TO_ABSOLUTE: false,
